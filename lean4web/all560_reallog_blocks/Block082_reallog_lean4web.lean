...
Block 82 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block082RightChunk000 : List RatBox := [
  ...
  { w1 := ((8456435126348999 : Rat) / 2500000000000000), w2 := (0 : Rat), w3 := (0 : Rat), w4 := ((239944700387829 : Rat) / 1000000000000000), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((107000619 : Rat) / 40000000), s4 := ((27844905749999999 : Rat) / 10000000000000000), L := ((221664494999999993 : Rat) / 80000000000000000), R := ((27844905749999999 : Rat) / 10000000000000000), D0 := ((27844905749999999 : Rat) / 10000000000000000), D1 := ((9670154749999999 : Rat) / 10000000000000000), D2 := ((2265555749999999 : Rat) / 10000000000000000), D3 := ((1094750999999999 : Rat) / 10000000000000000), D4 := ((1094750999999999 : Rat) / 80000000000000000), LB := ((11910469774767307 : Rat) / 100000000000000000) },
  { w1 := ((8456435126348999 : Rat) / 2500000000000000), w2 := (0 : Rat), w3 := (0 : Rat), w4 := ((239944700387829 : Rat) / 1000000000000000), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((107000619 : Rat) / 40000000), s4 := ((27844905749999999 : Rat) / 10000000000000000), L := ((27844905749999999 : Rat) / 10000000000000000), R := ((70036118303571428589 : Rat) / 25000000000000000000), D0 := ((70036118303571428589 : Rat) / 25000000000000000000), D1 := ((24599240803571428589 : Rat) / 25000000000000000000), D2 := ((6087743303571428589 : Rat) / 25000000000000000000), D3 := ((3160731428571428589 : Rat) / 25000000000000000000), D4 := ((423853928571431089 : Rat) / 25000000000000000000), LB := ((2839799025132317 : Rat) / 1000000000000000000) }
]

def block082RightChunk000L : Rat := ((90062462053571428607 : Rat) / 50000000000000000000)
def block082RightChunk000R : Rat := ((70036118303571428589 : Rat) / 25000000000000000000)

def block082RightChunk000Certificate : Bool :=
  allBoxesValid block082RightChunk000 &&
  coversFromBool block082RightChunk000 block082RightChunk000L block082RightChunk000R

theorem block082RightChunk000Certificate_eq_true :
    block082RightChunk000Certificate = true := by
  native_decide

def block082RightChainCertificate : Bool :=
  decide (
    block082RightL = ((90062462053571428607 : Rat) / 50000000000000000000) /\
    ((70036118303571428589 : Rat) / 25000000000000000000) = block082RightR)

theorem block082RightChainCertificate_eq_true :
    block082RightChainCertificate = true := by
  native_decide

def block082LeftBoxCount : Nat := boxCount block082LeftBoxes
def block082RightBoxCount : Nat := 58

def block082_rational_certificate : Prop :=
    block082LeftCertificate = true /\
    block082RightChainCertificate = true /\
    block082RightChunk000Certificate = true

theorem block082_rational_certificate_proof :
    block082_rational_certificate := by
  exact ⟨block082LeftCertificate_eq_true, block082RightChainCertificate_eq_true, block082RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block082.block082V
#check Erdos1038Lean.M1817475.Block082.block082_left_V_pos
#check Erdos1038Lean.M1817475.Block082.block082_right_V_pos
#check Erdos1038Lean.M1817475.Block082.block082_reallog_certificate_proof
