...
Block 302 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block302LeftL : Rat := ((37912060267857142987 : Rat) / 50000000000000000000)
def block302LeftR : Rat := ((18960917410714285779 : Rat) / 25000000000000000000)
def block302RightL : Rat := ((87912060267857142987 : Rat) / 50000000000000000000)
def block302RightR : Rat := ((68960917410714285779 : Rat) / 25000000000000000000)

def block302LeftBoxes : List RatBox := [
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((37912060267857142987 : Rat) / 50000000000000000000), R := ((18960917410714285779 : Rat) / 25000000000000000000), D0 := ((18960917410714285779 : Rat) / 25000000000000000000), D1 := ((52961694732142857013 : Rat) / 50000000000000000000), D2 := ((89984689732142857013 : Rat) / 50000000000000000000), D3 := ((49067866785714285599 : Rat) / 25000000000000000000), D4 := ((20383698160714284683 : Rat) / 10000000000000000000), LB := ((881619747733961 : Rat) / 100000000000000000) }
]

def block302LeftCertificate : Bool :=
  allBoxesValid block302LeftBoxes &&
  coversFromBool block302LeftBoxes block302LeftL block302LeftR

theorem block302LeftCertificate_eq_true :
    block302LeftCertificate = true := by
  native_decide

def block302RightChunk000 : List RatBox := [
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((87912060267857142987 : Rat) / 50000000000000000000), R := ((18174751 : Rat) / 10000000), D0 := ((18174751 : Rat) / 10000000), D1 := ((2961694732142857013 : Rat) / 50000000000000000000), D2 := ((39984689732142857013 : Rat) / 50000000000000000000), D3 := ((24067866785714285599 : Rat) / 25000000000000000000), D4 := ((10383698160714284683 : Rat) / 10000000000000000000), LB := ((2231225350828203 : Rat) / 1000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((18174751 : Rat) / 10000000), R := ((43754101 : Rat) / 20000000), D0 := ((43754101 : Rat) / 20000000), D1 := ((7404599 : Rat) / 20000000), D2 := ((7404599 : Rat) / 10000000), D3 := ((9034807767857142837 : Rat) / 10000000000000000000), D4 := ((24478398035714283201 : Rat) / 25000000000000000000), LB := ((24630706296716143 : Rat) / 100000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((43754101 : Rat) / 20000000), R := ((182421003 : Rat) / 80000000), D0 := ((182421003 : Rat) / 80000000), D1 := ((7404599 : Rat) / 16000000), D2 := ((7404599 : Rat) / 20000000), D3 := ((5332508267857142837 : Rat) / 10000000000000000000), D4 := ((15222649285714283201 : Rat) / 25000000000000000000), LB := ((7967946843692597 : Rat) / 50000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((182421003 : Rat) / 80000000), R := ((94912801 : Rat) / 40000000), D0 := ((94912801 : Rat) / 40000000), D1 := ((22213797 : Rat) / 40000000), D2 := ((22213797 : Rat) / 80000000), D3 := ((4406933392857142837 : Rat) / 10000000000000000000), D4 := ((12908712098214283201 : Rat) / 25000000000000000000), LB := ((398361745876899 : Rat) / 100000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((94912801 : Rat) / 40000000), R := ((766707007 : Rat) / 320000000), D0 := ((766707007 : Rat) / 320000000), D1 := ((7404599 : Rat) / 12800000), D2 := ((7404599 : Rat) / 40000000), D3 := ((3481358517857142837 : Rat) / 10000000000000000000), D4 := ((10594774910714283201 : Rat) / 25000000000000000000), LB := ((7441336125431941 : Rat) / 200000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((766707007 : Rat) / 320000000), R := ((387055803 : Rat) / 160000000), D0 := ((387055803 : Rat) / 160000000), D1 := ((96259787 : Rat) / 160000000), D2 := ((51832193 : Rat) / 320000000), D3 := ((3249964799107142837 : Rat) / 10000000000000000000), D4 := ((10016290613839283201 : Rat) / 25000000000000000000), LB := ((3435552074868703 : Rat) / 250000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((387055803 : Rat) / 160000000), R := ((1555627811 : Rat) / 640000000), D0 := ((1555627811 : Rat) / 640000000), D1 := ((392443747 : Rat) / 640000000), D2 := ((22213797 : Rat) / 160000000), D3 := ((3018571080357142837 : Rat) / 10000000000000000000), D4 := ((9437806316964283201 : Rat) / 25000000000000000000), LB := ((3508367449070171 : Rat) / 200000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1555627811 : Rat) / 640000000), R := ((156303241 : Rat) / 64000000), D0 := ((156303241 : Rat) / 64000000), D1 := ((199924173 : Rat) / 320000000), D2 := ((81450589 : Rat) / 640000000), D3 := ((2902874220982142837 : Rat) / 10000000000000000000), D4 := ((9148564168526783201 : Rat) / 25000000000000000000), LB := ((4520819947492677 : Rat) / 500000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((156303241 : Rat) / 64000000), R := ((1570437009 : Rat) / 640000000), D0 := ((1570437009 : Rat) / 640000000), D1 := ((81450589 : Rat) / 128000000), D2 := ((7404599 : Rat) / 64000000), D3 := ((2787177361607142837 : Rat) / 10000000000000000000), D4 := ((8859322020089283201 : Rat) / 25000000000000000000), LB := ((87113592360899 : Rat) / 50000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1570437009 : Rat) / 640000000), R := ((3148278617 : Rat) / 1280000000), D0 := ((3148278617 : Rat) / 1280000000), D1 := ((821910489 : Rat) / 1280000000), D2 := ((66641391 : Rat) / 640000000), D3 := ((2671480502232142837 : Rat) / 10000000000000000000), D4 := ((8570079871651783201 : Rat) / 25000000000000000000), LB := ((1753014562741989 : Rat) / 250000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3148278617 : Rat) / 1280000000), R := ((197230201 : Rat) / 80000000), D0 := ((197230201 : Rat) / 80000000), D1 := ((51832193 : Rat) / 80000000), D2 := ((125878183 : Rat) / 1280000000), D3 := ((2613632072544642837 : Rat) / 10000000000000000000), D4 := ((8425458797433033201 : Rat) / 25000000000000000000), LB := ((1117211370767271 : Rat) / 250000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((197230201 : Rat) / 80000000), R := ((632617563 : Rat) / 256000000), D0 := ((632617563 : Rat) / 256000000), D1 := ((836719687 : Rat) / 1280000000), D2 := ((7404599 : Rat) / 80000000), D3 := ((2555783642857142837 : Rat) / 10000000000000000000), D4 := ((8280837723214283201 : Rat) / 25000000000000000000), LB := ((1156687149768687 : Rat) / 500000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((632617563 : Rat) / 256000000), R := ((1585246207 : Rat) / 640000000), D0 := ((1585246207 : Rat) / 640000000), D1 := ((422062143 : Rat) / 640000000), D2 := ((22213797 : Rat) / 256000000), D3 := ((2497935213169642837 : Rat) / 10000000000000000000), D4 := ((8136216648995533201 : Rat) / 25000000000000000000), LB := ((5723692970282523 : Rat) / 10000000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1585246207 : Rat) / 640000000), R := ((6348389427 : Rat) / 2560000000), D0 := ((6348389427 : Rat) / 2560000000), D1 := ((1695653171 : Rat) / 2560000000), D2 := ((51832193 : Rat) / 640000000), D3 := ((2440086783482142837 : Rat) / 10000000000000000000), D4 := ((7991595574776783201 : Rat) / 25000000000000000000), LB := ((954306240941527 : Rat) / 200000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6348389427 : Rat) / 2560000000), R := ((3177897013 : Rat) / 1280000000), D0 := ((3177897013 : Rat) / 1280000000), D1 := ((170305777 : Rat) / 256000000), D2 := ((199924173 : Rat) / 2560000000), D3 := ((2411162568638392837 : Rat) / 10000000000000000000), D4 := ((7919285037667408201 : Rat) / 25000000000000000000), LB := ((4282986807008671 : Rat) / 1000000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3177897013 : Rat) / 1280000000), R := ((50905589 : Rat) / 20480000), D0 := ((50905589 : Rat) / 20480000), D1 := ((1710462369 : Rat) / 2560000000), D2 := ((96259787 : Rat) / 1280000000), D3 := ((2382238353794642837 : Rat) / 10000000000000000000), D4 := ((7846974500558033201 : Rat) / 25000000000000000000), LB := ((1960546905298649 : Rat) / 500000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((50905589 : Rat) / 20480000), R := ((796325403 : Rat) / 320000000), D0 := ((796325403 : Rat) / 320000000), D1 := ((214733371 : Rat) / 320000000), D2 := ((7404599 : Rat) / 102400000), D3 := ((2353314138950892837 : Rat) / 10000000000000000000), D4 := ((7774663963448658201 : Rat) / 25000000000000000000), LB := ((36919513454731767 : Rat) / 10000000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((796325403 : Rat) / 320000000), R := ((6378007823 : Rat) / 2560000000), D0 := ((6378007823 : Rat) / 2560000000), D1 := ((1725271567 : Rat) / 2560000000), D2 := ((22213797 : Rat) / 320000000), D3 := ((2324389924107142837 : Rat) / 10000000000000000000), D4 := ((7702353426339283201 : Rat) / 25000000000000000000), LB := ((7204694595982497 : Rat) / 2000000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6378007823 : Rat) / 2560000000), R := ((3192706211 : Rat) / 1280000000), D0 := ((3192706211 : Rat) / 1280000000), D1 := ((866338083 : Rat) / 1280000000), D2 := ((170305777 : Rat) / 2560000000), D3 := ((2295465709263392837 : Rat) / 10000000000000000000), D4 := ((7630042889229908201 : Rat) / 25000000000000000000), LB := ((9149677528227651 : Rat) / 2500000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3192706211 : Rat) / 1280000000), R := ((6392817021 : Rat) / 2560000000), D0 := ((6392817021 : Rat) / 2560000000), D1 := ((348016153 : Rat) / 512000000), D2 := ((81450589 : Rat) / 1280000000), D3 := ((2266541494419642837 : Rat) / 10000000000000000000), D4 := ((7557732352120533201 : Rat) / 25000000000000000000), LB := ((38730507817031357 : Rat) / 10000000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6392817021 : Rat) / 2560000000), R := ((320011081 : Rat) / 128000000), D0 := ((320011081 : Rat) / 128000000), D1 := ((436871341 : Rat) / 640000000), D2 := ((155496579 : Rat) / 2560000000), D3 := ((2237617279575892837 : Rat) / 10000000000000000000), D4 := ((7485421815011158201 : Rat) / 25000000000000000000), LB := ((42515230558689 : Rat) / 10000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((320011081 : Rat) / 128000000), R := ((6407626219 : Rat) / 2560000000), D0 := ((6407626219 : Rat) / 2560000000), D1 := ((1754889963 : Rat) / 2560000000), D2 := ((7404599 : Rat) / 128000000), D3 := ((2208693064732142837 : Rat) / 10000000000000000000), D4 := ((7413111277901783201 : Rat) / 25000000000000000000), LB := ((4806242592098053 : Rat) / 1000000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6407626219 : Rat) / 2560000000), R := ((3207515409 : Rat) / 1280000000), D0 := ((3207515409 : Rat) / 1280000000), D1 := ((881147281 : Rat) / 1280000000), D2 := ((140687381 : Rat) / 2560000000), D3 := ((2179768849888392837 : Rat) / 10000000000000000000), D4 := ((7340800740792408201 : Rat) / 25000000000000000000), LB := ((554974617731957 : Rat) / 100000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3207515409 : Rat) / 1280000000), R := ((401865001 : Rat) / 160000000), D0 := ((401865001 : Rat) / 160000000), D1 := ((22213797 : Rat) / 32000000), D2 := ((66641391 : Rat) / 1280000000), D3 := ((2150844635044642837 : Rat) / 10000000000000000000), D4 := ((7268490203683033201 : Rat) / 25000000000000000000), LB := ((1196705004634091 : Rat) / 1000000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((401865001 : Rat) / 160000000), R := ((3222324607 : Rat) / 1280000000), D0 := ((3222324607 : Rat) / 1280000000), D1 := ((895956479 : Rat) / 1280000000), D2 := ((7404599 : Rat) / 160000000), D3 := ((2092996205357142837 : Rat) / 10000000000000000000), D4 := ((7123869129464283201 : Rat) / 25000000000000000000), LB := ((2379377017035951 : Rat) / 625000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3222324607 : Rat) / 1280000000), R := ((1614864603 : Rat) / 640000000), D0 := ((1614864603 : Rat) / 640000000), D1 := ((451680539 : Rat) / 640000000), D2 := ((51832193 : Rat) / 1280000000), D3 := ((2035147775669642837 : Rat) / 10000000000000000000), D4 := ((6979248055245533201 : Rat) / 25000000000000000000), LB := ((934218841234423 : Rat) / 125000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1614864603 : Rat) / 640000000), R := ((811134601 : Rat) / 320000000), D0 := ((811134601 : Rat) / 320000000), D1 := ((229542569 : Rat) / 320000000), D2 := ((22213797 : Rat) / 640000000), D3 := ((1977299345982142837 : Rat) / 10000000000000000000), D4 := ((6834626981026783201 : Rat) / 25000000000000000000), LB := ((21202193457363627 : Rat) / 10000000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((811134601 : Rat) / 320000000), R := ((1629673801 : Rat) / 640000000), D0 := ((1629673801 : Rat) / 640000000), D1 := ((466489737 : Rat) / 640000000), D2 := ((7404599 : Rat) / 320000000), D3 := ((1861602486607142837 : Rat) / 10000000000000000000), D4 := ((6545384832589283201 : Rat) / 25000000000000000000), LB := ((896130351454641 : Rat) / 50000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1629673801 : Rat) / 640000000), R := ((511587 : Rat) / 200000), D0 := ((511587 : Rat) / 200000), D1 := ((7404599 : Rat) / 10000000), D2 := ((7404599 : Rat) / 640000000), D3 := ((1745905627232142837 : Rat) / 10000000000000000000), D4 := ((6256142684151783201 : Rat) / 25000000000000000000), LB := ((984734920793 : Rat) / 20000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((511587 : Rat) / 200000), R := ((206265008767857142837 : Rat) / 80000000000000000000), D0 := ((206265008767857142837 : Rat) / 80000000000000000000), D1 := ((60867000767857142837 : Rat) / 80000000000000000000), D2 := ((1630208767857142837 : Rat) / 80000000000000000000), D3 := ((1630208767857142837 : Rat) / 10000000000000000000), D4 := ((5966900535714283201 : Rat) / 25000000000000000000), LB := ((2422633922542633 : Rat) / 500000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((206265008767857142837 : Rat) / 80000000000000000000), R := ((414160226303571428511 : Rat) / 160000000000000000000), D0 := ((414160226303571428511 : Rat) / 160000000000000000000), D1 := ((123364210303571428511 : Rat) / 160000000000000000000), D2 := ((4890626303571428511 : Rat) / 160000000000000000000), D3 := ((11411461374999999859 : Rat) / 80000000000000000000), D4 := ((87319364732142817031 : Rat) / 400000000000000000000), LB := ((1443010602735173 : Rat) / 400000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((414160226303571428511 : Rat) / 160000000000000000000), R := ((829950661374999999859 : Rat) / 320000000000000000000), D0 := ((829950661374999999859 : Rat) / 320000000000000000000), D1 := ((248358629374999999859 : Rat) / 320000000000000000000), D2 := ((11411461374999999859 : Rat) / 320000000000000000000), D3 := ((21192713982142856881 : Rat) / 160000000000000000000), D4 := ((166487685624999919877 : Rat) / 800000000000000000000), LB := ((1858734406133239 : Rat) / 250000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((829950661374999999859 : Rat) / 320000000000000000000), R := ((103947608767857142837 : Rat) / 40000000000000000000), D0 := ((103947608767857142837 : Rat) / 40000000000000000000), D1 := ((31248604767857142837 : Rat) / 40000000000000000000), D2 := ((1630208767857142837 : Rat) / 40000000000000000000), D3 := ((1630208767857142837 : Rat) / 12800000000000000000), D4 := ((324824327410714125569 : Rat) / 1600000000000000000000), LB := ((36711224399609 : Rat) / 12500000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((103947608767857142837 : Rat) / 40000000000000000000), R := ((1664791949053571428229 : Rat) / 640000000000000000000), D0 := ((1664791949053571428229 : Rat) / 640000000000000000000), D1 := ((501607885053571428229 : Rat) / 640000000000000000000), D2 := ((27713549053571428229 : Rat) / 640000000000000000000), D3 := ((4890626303571428511 : Rat) / 40000000000000000000), D4 := ((39584160446428551423 : Rat) / 200000000000000000000), LB := ((6717753868294207 : Rat) / 1000000000000000000) },
  ...
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((107208026303571428511 : Rat) / 40000000000000000000), R := ((27209558767857142837 : Rat) / 10000000000000000000), D0 := ((27209558767857142837 : Rat) / 10000000000000000000), D1 := ((9034807767857142837 : Rat) / 10000000000000000000), D2 := ((1630208767857142837 : Rat) / 10000000000000000000), D3 := ((1630208767857142837 : Rat) / 40000000000000000000), D4 := ((23282072767857123053 : Rat) / 200000000000000000000), LB := ((25382053890273093 : Rat) / 500000000000000000) },
  { w1 := ((1986658904642177 : Rat) / 2000000000000000), w2 := ((12344563576176049 : Rat) / 250000000000000000), w3 := ((2691599261825117 : Rat) / 10000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((27209558767857142837 : Rat) / 10000000000000000000), R := ((68960917410714285779 : Rat) / 25000000000000000000), D0 := ((68960917410714285779 : Rat) / 25000000000000000000), D1 := ((23524039910714285779 : Rat) / 25000000000000000000), D2 := ((5012542410714285779 : Rat) / 25000000000000000000), D3 := ((1874040982142857373 : Rat) / 50000000000000000000), D4 := ((3782757232142852217 : Rat) / 50000000000000000000), LB := ((451585825303541 : Rat) / 50000000000000000) }
]

def block302RightChunk000L : Rat := ((87912060267857142987 : Rat) / 50000000000000000000)
def block302RightChunk000R : Rat := ((68960917410714285779 : Rat) / 25000000000000000000)

def block302RightChunk000Certificate : Bool :=
  allBoxesValid block302RightChunk000 &&
  coversFromBool block302RightChunk000 block302RightChunk000L block302RightChunk000R

theorem block302RightChunk000Certificate_eq_true :
    block302RightChunk000Certificate = true := by
  native_decide

def block302RightChainCertificate : Bool :=
  decide (
    block302RightL = ((87912060267857142987 : Rat) / 50000000000000000000) /\
    ((68960917410714285779 : Rat) / 25000000000000000000) = block302RightR)

theorem block302RightChainCertificate_eq_true :
    block302RightChainCertificate = true := by
  native_decide

def block302LeftBoxCount : Nat := boxCount block302LeftBoxes
def block302RightBoxCount : Nat := 52

def block302_rational_certificate : Prop :=
    block302LeftCertificate = true /\
    block302RightChainCertificate = true /\
    block302RightChunk000Certificate = true

theorem block302_rational_certificate_proof :
    block302_rational_certificate := by
  exact ⟨block302LeftCertificate_eq_true, block302RightChainCertificate_eq_true, block302RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block302.block302V
#check Erdos1038Lean.M1817475.Block302.block302_left_V_pos
#check Erdos1038Lean.M1817475.Block302.block302_right_V_pos
#check Erdos1038Lean.M1817475.Block302.block302_reallog_certificate_proof
