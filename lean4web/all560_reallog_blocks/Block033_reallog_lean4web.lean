...
Block 33 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block033RightChunk000 : List RatBox := [
  ...
  { w1 := ((589199718741 : Rat) / 244140625000), w2 := (0 : Rat), w3 := (0 : Rat), w4 := ((14058598175803133 : Rat) / 50000000000000000), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((107000619 : Rat) / 40000000), s4 := ((27844905749999999 : Rat) / 10000000000000000), L := ((27844905749999999 : Rat) / 10000000000000000), R := ((140551189732142857157 : Rat) / 50000000000000000000), D0 := ((140551189732142857157 : Rat) / 50000000000000000000), D1 := ((49677434732142857157 : Rat) / 50000000000000000000), D2 := ((12654439732142857157 : Rat) / 50000000000000000000), D3 := ((6800415982142857157 : Rat) / 50000000000000000000), D4 := ((1326660982142862157 : Rat) / 50000000000000000000), LB := ((5089325311239623 : Rat) / 2000000000000000000) }
]

def block033RightChunk000L : Rat := ((45270707589285714293 : Rat) / 25000000000000000000)
def block033RightChunk000R : Rat := ((140551189732142857157 : Rat) / 50000000000000000000)

def block033RightChunk000Certificate : Bool :=
  allBoxesValid block033RightChunk000 &&
  coversFromBool block033RightChunk000 block033RightChunk000L block033RightChunk000R

theorem block033RightChunk000Certificate_eq_true :
    block033RightChunk000Certificate = true := by
  native_decide

def block033RightChainCertificate : Bool :=
  decide (
    block033RightL = ((45270707589285714293 : Rat) / 25000000000000000000) /\
    ((140551189732142857157 : Rat) / 50000000000000000000) = block033RightR)

theorem block033RightChainCertificate_eq_true :
    block033RightChainCertificate = true := by
  native_decide

def block033LeftBoxCount : Nat := boxCount block033LeftBoxes
def block033RightBoxCount : Nat := 68

def block033_rational_certificate : Prop :=
    block033LeftCertificate = true /\
    block033RightChainCertificate = true /\
    block033RightChunk000Certificate = true

theorem block033_rational_certificate_proof :
    block033_rational_certificate := by
  exact ⟨block033LeftCertificate_eq_true, block033RightChainCertificate_eq_true, block033RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block033.block033V
#check Erdos1038Lean.M1817475.Block033.block033_left_V_pos
#check Erdos1038Lean.M1817475.Block033.block033_right_V_pos
#check Erdos1038Lean.M1817475.Block033.block033_reallog_certificate_proof
