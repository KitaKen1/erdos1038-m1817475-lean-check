...
Block 294 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block294LeftL : Rat := ((7598051339285714311 : Rat) / 10000000000000000000)
def block294LeftR : Rat := ((19000015625000000063 : Rat) / 25000000000000000000)
def block294RightL : Rat := ((17598051339285714311 : Rat) / 10000000000000000000)
def block294RightR : Rat := ((69000015625000000063 : Rat) / 25000000000000000000)

def block294LeftBoxes : List RatBox := [
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((7598051339285714311 : Rat) / 10000000000000000000), R := ((19000015625000000063 : Rat) / 25000000000000000000), D0 := ((19000015625000000063 : Rat) / 25000000000000000000), D1 := ((10576699660714285689 : Rat) / 10000000000000000000), D2 := ((17981298660714285689 : Rat) / 10000000000000000000), D3 := ((9805753714285714263 : Rat) / 5000000000000000000), D4 := ((101840294374999994847 : Rat) / 50000000000000000000), LB := ((7008637700541859 : Rat) / 1000000000000000000) }
]

def block294LeftCertificate : Bool :=
  allBoxesValid block294LeftBoxes &&
  coversFromBool block294LeftBoxes block294LeftL block294LeftR

theorem block294LeftCertificate_eq_true :
    block294LeftCertificate = true := by
  native_decide

def block294RightChunk000 : List RatBox := [
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((17598051339285714311 : Rat) / 10000000000000000000), R := ((18174751 : Rat) / 10000000), D0 := ((18174751 : Rat) / 10000000), D1 := ((576699660714285689 : Rat) / 10000000000000000000), D2 := ((7981298660714285689 : Rat) / 10000000000000000000), D3 := ((4805753714285714263 : Rat) / 5000000000000000000), D4 := ((51840294374999994847 : Rat) / 50000000000000000000), LB := ((4642429522993587 : Rat) / 2000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((18174751 : Rat) / 10000000), R := ((43754101 : Rat) / 20000000), D0 := ((43754101 : Rat) / 20000000), D1 := ((7404599 : Rat) / 20000000), D2 := ((7404599 : Rat) / 10000000), D3 := ((9034807767857142837 : Rat) / 10000000000000000000), D4 := ((24478398035714283201 : Rat) / 25000000000000000000), LB := ((26710908139615147 : Rat) / 100000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((43754101 : Rat) / 20000000), R := ((182421003 : Rat) / 80000000), D0 := ((182421003 : Rat) / 80000000), D1 := ((7404599 : Rat) / 16000000), D2 := ((7404599 : Rat) / 20000000), D3 := ((5332508267857142837 : Rat) / 10000000000000000000), D4 := ((15222649285714283201 : Rat) / 25000000000000000000), LB := ((17348765897890603 : Rat) / 100000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((182421003 : Rat) / 80000000), R := ((94912801 : Rat) / 40000000), D0 := ((94912801 : Rat) / 40000000), D1 := ((22213797 : Rat) / 40000000), D2 := ((22213797 : Rat) / 80000000), D3 := ((4406933392857142837 : Rat) / 10000000000000000000), D4 := ((12908712098214283201 : Rat) / 25000000000000000000), LB := ((13121428634717991 : Rat) / 1000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((94912801 : Rat) / 40000000), R := ((766707007 : Rat) / 320000000), D0 := ((766707007 : Rat) / 320000000), D1 := ((7404599 : Rat) / 12800000), D2 := ((7404599 : Rat) / 40000000), D3 := ((3481358517857142837 : Rat) / 10000000000000000000), D4 := ((10594774910714283201 : Rat) / 25000000000000000000), LB := ((4395280739603691 : Rat) / 100000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((766707007 : Rat) / 320000000), R := ((387055803 : Rat) / 160000000), D0 := ((387055803 : Rat) / 160000000), D1 := ((96259787 : Rat) / 160000000), D2 := ((51832193 : Rat) / 320000000), D3 := ((3249964799107142837 : Rat) / 10000000000000000000), D4 := ((10016290613839283201 : Rat) / 25000000000000000000), LB := ((19057070569782453 : Rat) / 1000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((387055803 : Rat) / 160000000), R := ((1555627811 : Rat) / 640000000), D0 := ((1555627811 : Rat) / 640000000), D1 := ((392443747 : Rat) / 640000000), D2 := ((22213797 : Rat) / 160000000), D3 := ((3018571080357142837 : Rat) / 10000000000000000000), D4 := ((9437806316964283201 : Rat) / 25000000000000000000), LB := ((21756957970887003 : Rat) / 1000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1555627811 : Rat) / 640000000), R := ((156303241 : Rat) / 64000000), D0 := ((156303241 : Rat) / 64000000), D1 := ((199924173 : Rat) / 320000000), D2 := ((81450589 : Rat) / 640000000), D3 := ((2902874220982142837 : Rat) / 10000000000000000000), D4 := ((9148564168526783201 : Rat) / 25000000000000000000), LB := ((12438599277312501 : Rat) / 1000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((156303241 : Rat) / 64000000), R := ((1570437009 : Rat) / 640000000), D0 := ((1570437009 : Rat) / 640000000), D1 := ((81450589 : Rat) / 128000000), D2 := ((7404599 : Rat) / 64000000), D3 := ((2787177361607142837 : Rat) / 10000000000000000000), D4 := ((8859322020089283201 : Rat) / 25000000000000000000), LB := ((8551883071437949 : Rat) / 2000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1570437009 : Rat) / 640000000), R := ((3148278617 : Rat) / 1280000000), D0 := ((3148278617 : Rat) / 1280000000), D1 := ((821910489 : Rat) / 1280000000), D2 := ((66641391 : Rat) / 640000000), D3 := ((2671480502232142837 : Rat) / 10000000000000000000), D4 := ((8570079871651783201 : Rat) / 25000000000000000000), LB := ((8826712681124449 : Rat) / 1000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3148278617 : Rat) / 1280000000), R := ((197230201 : Rat) / 80000000), D0 := ((197230201 : Rat) / 80000000), D1 := ((51832193 : Rat) / 80000000), D2 := ((125878183 : Rat) / 1280000000), D3 := ((2613632072544642837 : Rat) / 10000000000000000000), D4 := ((8425458797433033201 : Rat) / 25000000000000000000), LB := ((2897051060790523 : Rat) / 500000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((197230201 : Rat) / 80000000), R := ((632617563 : Rat) / 256000000), D0 := ((632617563 : Rat) / 256000000), D1 := ((836719687 : Rat) / 1280000000), D2 := ((7404599 : Rat) / 80000000), D3 := ((2555783642857142837 : Rat) / 10000000000000000000), D4 := ((8280837723214283201 : Rat) / 25000000000000000000), LB := ((31277277017332517 : Rat) / 10000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((632617563 : Rat) / 256000000), R := ((1585246207 : Rat) / 640000000), D0 := ((1585246207 : Rat) / 640000000), D1 := ((422062143 : Rat) / 640000000), D2 := ((22213797 : Rat) / 256000000), D3 := ((2497935213169642837 : Rat) / 10000000000000000000), D4 := ((8136216648995533201 : Rat) / 25000000000000000000), LB := ((4254926261211267 : Rat) / 5000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1585246207 : Rat) / 640000000), R := ((6348389427 : Rat) / 2560000000), D0 := ((6348389427 : Rat) / 2560000000), D1 := ((1695653171 : Rat) / 2560000000), D2 := ((51832193 : Rat) / 640000000), D3 := ((2440086783482142837 : Rat) / 10000000000000000000), D4 := ((7991595574776783201 : Rat) / 25000000000000000000), LB := ((4583803252768359 : Rat) / 1000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6348389427 : Rat) / 2560000000), R := ((3177897013 : Rat) / 1280000000), D0 := ((3177897013 : Rat) / 1280000000), D1 := ((170305777 : Rat) / 256000000), D2 := ((199924173 : Rat) / 2560000000), D3 := ((2411162568638392837 : Rat) / 10000000000000000000), D4 := ((7919285037667408201 : Rat) / 25000000000000000000), LB := ((38002021558216637 : Rat) / 10000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3177897013 : Rat) / 1280000000), R := ((50905589 : Rat) / 20480000), D0 := ((50905589 : Rat) / 20480000), D1 := ((1710462369 : Rat) / 2560000000), D2 := ((96259787 : Rat) / 1280000000), D3 := ((2382238353794642837 : Rat) / 10000000000000000000), D4 := ((7846974500558033201 : Rat) / 25000000000000000000), LB := ((15670488233335833 : Rat) / 5000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((50905589 : Rat) / 20480000), R := ((796325403 : Rat) / 320000000), D0 := ((796325403 : Rat) / 320000000), D1 := ((214733371 : Rat) / 320000000), D2 := ((7404599 : Rat) / 102400000), D3 := ((2353314138950892837 : Rat) / 10000000000000000000), D4 := ((7774663963448658201 : Rat) / 25000000000000000000), LB := ((5181557512850099 : Rat) / 2000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((796325403 : Rat) / 320000000), R := ((6378007823 : Rat) / 2560000000), D0 := ((6378007823 : Rat) / 2560000000), D1 := ((1725271567 : Rat) / 2560000000), D2 := ((22213797 : Rat) / 320000000), D3 := ((2324389924107142837 : Rat) / 10000000000000000000), D4 := ((7702353426339283201 : Rat) / 25000000000000000000), LB := ((108806120579083 : Rat) / 50000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6378007823 : Rat) / 2560000000), R := ((3192706211 : Rat) / 1280000000), D0 := ((3192706211 : Rat) / 1280000000), D1 := ((866338083 : Rat) / 1280000000), D2 := ((170305777 : Rat) / 2560000000), D3 := ((2295465709263392837 : Rat) / 10000000000000000000), D4 := ((7630042889229908201 : Rat) / 25000000000000000000), LB := ((3793377670783249 : Rat) / 2000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3192706211 : Rat) / 1280000000), R := ((6392817021 : Rat) / 2560000000), D0 := ((6392817021 : Rat) / 2560000000), D1 := ((348016153 : Rat) / 512000000), D2 := ((81450589 : Rat) / 1280000000), D3 := ((2266541494419642837 : Rat) / 10000000000000000000), D4 := ((7557732352120533201 : Rat) / 25000000000000000000), LB := ((3519675780976339 : Rat) / 2000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6392817021 : Rat) / 2560000000), R := ((320011081 : Rat) / 128000000), D0 := ((320011081 : Rat) / 128000000), D1 := ((436871341 : Rat) / 640000000), D2 := ((155496579 : Rat) / 2560000000), D3 := ((2237617279575892837 : Rat) / 10000000000000000000), D4 := ((7485421815011158201 : Rat) / 25000000000000000000), LB := ((17738721898897247 : Rat) / 10000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((320011081 : Rat) / 128000000), R := ((6407626219 : Rat) / 2560000000), D0 := ((6407626219 : Rat) / 2560000000), D1 := ((1754889963 : Rat) / 2560000000), D2 := ((7404599 : Rat) / 128000000), D3 := ((2208693064732142837 : Rat) / 10000000000000000000), D4 := ((7413111277901783201 : Rat) / 25000000000000000000), LB := ((389642958776637 : Rat) / 200000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6407626219 : Rat) / 2560000000), R := ((3207515409 : Rat) / 1280000000), D0 := ((3207515409 : Rat) / 1280000000), D1 := ((881147281 : Rat) / 1280000000), D2 := ((140687381 : Rat) / 2560000000), D3 := ((2179768849888392837 : Rat) / 10000000000000000000), D4 := ((7340800740792408201 : Rat) / 25000000000000000000), LB := ((1146816059078043 : Rat) / 500000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3207515409 : Rat) / 1280000000), R := ((6422435417 : Rat) / 2560000000), D0 := ((6422435417 : Rat) / 2560000000), D1 := ((1769699161 : Rat) / 2560000000), D2 := ((66641391 : Rat) / 1280000000), D3 := ((2150844635044642837 : Rat) / 10000000000000000000), D4 := ((7268490203683033201 : Rat) / 25000000000000000000), LB := ((7056291756708799 : Rat) / 2500000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6422435417 : Rat) / 2560000000), R := ((401865001 : Rat) / 160000000), D0 := ((401865001 : Rat) / 160000000), D1 := ((22213797 : Rat) / 32000000), D2 := ((125878183 : Rat) / 2560000000), D3 := ((2121920420200892837 : Rat) / 10000000000000000000), D4 := ((7196179666573658201 : Rat) / 25000000000000000000), LB := ((17746251789323153 : Rat) / 5000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((401865001 : Rat) / 160000000), R := ((1287448923 : Rat) / 512000000), D0 := ((1287448923 : Rat) / 512000000), D1 := ((1784508359 : Rat) / 2560000000), D2 := ((7404599 : Rat) / 160000000), D3 := ((2092996205357142837 : Rat) / 10000000000000000000), D4 := ((7123869129464283201 : Rat) / 25000000000000000000), LB := ((359254153769899 : Rat) / 80000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1287448923 : Rat) / 512000000), R := ((3222324607 : Rat) / 1280000000), D0 := ((3222324607 : Rat) / 1280000000), D1 := ((895956479 : Rat) / 1280000000), D2 := ((22213797 : Rat) / 512000000), D3 := ((2064071990513392837 : Rat) / 10000000000000000000), D4 := ((7051558592354908201 : Rat) / 25000000000000000000), LB := ((45333816745043 : Rat) / 8000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3222324607 : Rat) / 1280000000), R := ((1614864603 : Rat) / 640000000), D0 := ((1614864603 : Rat) / 640000000), D1 := ((451680539 : Rat) / 640000000), D2 := ((51832193 : Rat) / 1280000000), D3 := ((2035147775669642837 : Rat) / 10000000000000000000), D4 := ((6979248055245533201 : Rat) / 25000000000000000000), LB := ((8911417726306381 : Rat) / 5000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1614864603 : Rat) / 640000000), R := ((647426761 : Rat) / 256000000), D0 := ((647426761 : Rat) / 256000000), D1 := ((910765677 : Rat) / 1280000000), D2 := ((22213797 : Rat) / 640000000), D3 := ((1977299345982142837 : Rat) / 10000000000000000000), D4 := ((6834626981026783201 : Rat) / 25000000000000000000), LB := ((5585830982433093 : Rat) / 1000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((647426761 : Rat) / 256000000), R := ((811134601 : Rat) / 320000000), D0 := ((811134601 : Rat) / 320000000), D1 := ((229542569 : Rat) / 320000000), D2 := ((7404599 : Rat) / 256000000), D3 := ((1919450916294642837 : Rat) / 10000000000000000000), D4 := ((6690005906808033201 : Rat) / 25000000000000000000), LB := ((10871894229601609 : Rat) / 1000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((811134601 : Rat) / 320000000), R := ((1629673801 : Rat) / 640000000), D0 := ((1629673801 : Rat) / 640000000), D1 := ((466489737 : Rat) / 640000000), D2 := ((7404599 : Rat) / 320000000), D3 := ((1861602486607142837 : Rat) / 10000000000000000000), D4 := ((6545384832589283201 : Rat) / 25000000000000000000), LB := ((3905905534391879 : Rat) / 500000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1629673801 : Rat) / 640000000), R := ((511587 : Rat) / 200000), D0 := ((511587 : Rat) / 200000), D1 := ((7404599 : Rat) / 10000000), D2 := ((7404599 : Rat) / 640000000), D3 := ((1745905627232142837 : Rat) / 10000000000000000000), D4 := ((6256142684151783201 : Rat) / 25000000000000000000), LB := ((846847364951163 : Rat) / 25000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((511587 : Rat) / 200000), R := ((410899808767857142837 : Rat) / 160000000000000000000), D0 := ((410899808767857142837 : Rat) / 160000000000000000000), D1 := ((120103792767857142837 : Rat) / 160000000000000000000), D2 := ((1630208767857142837 : Rat) / 160000000000000000000), D3 := ((1630208767857142837 : Rat) / 10000000000000000000), D4 := ((5966900535714283201 : Rat) / 25000000000000000000), LB := ((160958117418879 : Rat) / 4000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((410899808767857142837 : Rat) / 160000000000000000000), R := ((206265008767857142837 : Rat) / 80000000000000000000), D0 := ((206265008767857142837 : Rat) / 80000000000000000000), D1 := ((60867000767857142837 : Rat) / 80000000000000000000), D2 := ((1630208767857142837 : Rat) / 80000000000000000000), D3 := ((4890626303571428511 : Rat) / 32000000000000000000), D4 := ((182789773303571348247 : Rat) / 800000000000000000000), LB := ((11544708930223413 : Rat) / 1000000000000000000) },
  ...
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((420681061374999999859 : Rat) / 160000000000000000000), R := ((168598466303571428511 : Rat) / 64000000000000000000), D0 := ((168598466303571428511 : Rat) / 64000000000000000000), D1 := ((52280059903571428511 : Rat) / 64000000000000000000), D2 := ((4890626303571428511 : Rat) / 64000000000000000000), D3 := ((14671878910714285533 : Rat) / 160000000000000000000), D4 := ((133883510267857063137 : Rat) / 800000000000000000000), LB := ((19336018421843293 : Rat) / 5000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((168598466303571428511 : Rat) / 64000000000000000000), R := ((52788908767857142837 : Rat) / 20000000000000000000), D0 := ((52788908767857142837 : Rat) / 20000000000000000000), D1 := ((16439406767857142837 : Rat) / 20000000000000000000), D2 := ((1630208767857142837 : Rat) / 20000000000000000000), D3 := ((27713549053571428229 : Rat) / 320000000000000000000), D4 := ((259615976696428412089 : Rat) / 1600000000000000000000), LB := ((1089673095923227 : Rat) / 125000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((52788908767857142837 : Rat) / 20000000000000000000), R := ((423941478910714285533 : Rat) / 160000000000000000000), D0 := ((423941478910714285533 : Rat) / 160000000000000000000), D1 := ((133145462910714285533 : Rat) / 160000000000000000000), D2 := ((14671878910714285533 : Rat) / 160000000000000000000), D3 := ((1630208767857142837 : Rat) / 20000000000000000000), D4 := ((15716558303571418619 : Rat) / 100000000000000000000), LB := ((4186653800920537 : Rat) / 1000000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((423941478910714285533 : Rat) / 160000000000000000000), R := ((42557168767857142837 : Rat) / 16000000000000000000), D0 := ((42557168767857142837 : Rat) / 16000000000000000000), D1 := ((13477567167857142837 : Rat) / 16000000000000000000), D2 := ((1630208767857142837 : Rat) / 16000000000000000000), D3 := ((11411461374999999859 : Rat) / 160000000000000000000), D4 := ((117581422589285634767 : Rat) / 800000000000000000000), LB := ((10238414356611103 : Rat) / 500000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((42557168767857142837 : Rat) / 16000000000000000000), R := ((107208026303571428511 : Rat) / 40000000000000000000), D0 := ((107208026303571428511 : Rat) / 40000000000000000000), D1 := ((34509022303571428511 : Rat) / 40000000000000000000), D2 := ((4890626303571428511 : Rat) / 40000000000000000000), D3 := ((4890626303571428511 : Rat) / 80000000000000000000), D4 := ((54715189374999960291 : Rat) / 400000000000000000000), LB := ((4708238738482673 : Rat) / 200000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((107208026303571428511 : Rat) / 40000000000000000000), R := ((27209558767857142837 : Rat) / 10000000000000000000), D0 := ((27209558767857142837 : Rat) / 10000000000000000000), D1 := ((9034807767857142837 : Rat) / 10000000000000000000), D2 := ((1630208767857142837 : Rat) / 10000000000000000000), D3 := ((1630208767857142837 : Rat) / 40000000000000000000), D4 := ((23282072767857123053 : Rat) / 200000000000000000000), LB := ((6155953271783343 : Rat) / 100000000000000000) },
  { w1 := ((2031760370300269 : Rat) / 2000000000000000), w2 := ((8332230287780383 : Rat) / 200000000000000000), w3 := ((1104768687047889 : Rat) / 4000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((27209558767857142837 : Rat) / 10000000000000000000), R := ((69000015625000000063 : Rat) / 25000000000000000000), D0 := ((69000015625000000063 : Rat) / 25000000000000000000), D1 := ((23563138125000000063 : Rat) / 25000000000000000000), D2 := ((5051640625000000063 : Rat) / 25000000000000000000), D3 := ((1952237410714285941 : Rat) / 50000000000000000000), D4 := ((3782757232142852217 : Rat) / 50000000000000000000), LB := ((7228484363937859 : Rat) / 1000000000000000000) }
]

def block294RightChunk000L : Rat := ((17598051339285714311 : Rat) / 10000000000000000000)
def block294RightChunk000R : Rat := ((69000015625000000063 : Rat) / 25000000000000000000)

def block294RightChunk000Certificate : Bool :=
  allBoxesValid block294RightChunk000 &&
  coversFromBool block294RightChunk000 block294RightChunk000L block294RightChunk000R

theorem block294RightChunk000Certificate_eq_true :
    block294RightChunk000Certificate = true := by
  native_decide

def block294RightChainCertificate : Bool :=
  decide (
    block294RightL = ((17598051339285714311 : Rat) / 10000000000000000000) /\
    ((69000015625000000063 : Rat) / 25000000000000000000) = block294RightR)

theorem block294RightChainCertificate_eq_true :
    block294RightChainCertificate = true := by
  native_decide

def block294LeftBoxCount : Nat := boxCount block294LeftBoxes
def block294RightBoxCount : Nat := 57

def block294_rational_certificate : Prop :=
    block294LeftCertificate = true /\
    block294RightChainCertificate = true /\
    block294RightChunk000Certificate = true

theorem block294_rational_certificate_proof :
    block294_rational_certificate := by
  exact ⟨block294LeftCertificate_eq_true, block294RightChainCertificate_eq_true, block294RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block294.block294V
#check Erdos1038Lean.M1817475.Block294.block294_left_V_pos
#check Erdos1038Lean.M1817475.Block294.block294_right_V_pos
#check Erdos1038Lean.M1817475.Block294.block294_reallog_certificate_proof
