...
Block 274 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block274RightChunk000 : List RatBox := [
  ...
  { w1 := ((5145152316669953 : Rat) / 5000000000000000), w2 := ((30739913052925973 : Rat) / 1000000000000000000), w3 := ((7260126985933589 : Rat) / 25000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((107208026303571428511 : Rat) / 40000000000000000000), R := ((27209558767857142837 : Rat) / 10000000000000000000), D0 := ((27209558767857142837 : Rat) / 10000000000000000000), D1 := ((9034807767857142837 : Rat) / 10000000000000000000), D2 := ((1630208767857142837 : Rat) / 10000000000000000000), D3 := ((1630208767857142837 : Rat) / 40000000000000000000), D4 := ((23282072767857123053 : Rat) / 200000000000000000000), LB := ((8856824881999237 : Rat) / 100000000000000000) },
  { w1 := ((5145152316669953 : Rat) / 5000000000000000), w2 := ((30739913052925973 : Rat) / 1000000000000000000), w3 := ((7260126985933589 : Rat) / 25000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((27209558767857142837 : Rat) / 10000000000000000000), R := ((69097761160714285773 : Rat) / 25000000000000000000), D0 := ((69097761160714285773 : Rat) / 25000000000000000000), D1 := ((23660883660714285773 : Rat) / 25000000000000000000), D2 := ((5149386160714285773 : Rat) / 25000000000000000000), D3 := ((2147728482142857361 : Rat) / 50000000000000000000), D4 := ((3782757232142852217 : Rat) / 50000000000000000000), LB := ((26559101090741777 : Rat) / 10000000000000000000) }
]

def block274RightChunk000L : Rat := ((3527429910714285719 : Rat) / 2000000000000000000)
def block274RightChunk000R : Rat := ((69097761160714285773 : Rat) / 25000000000000000000)

def block274RightChunk000Certificate : Bool :=
  allBoxesValid block274RightChunk000 &&
  coversFromBool block274RightChunk000 block274RightChunk000L block274RightChunk000R

theorem block274RightChunk000Certificate_eq_true :
    block274RightChunk000Certificate = true := by
  native_decide

def block274RightChainCertificate : Bool :=
  decide (
    block274RightL = ((3527429910714285719 : Rat) / 2000000000000000000) /\
    ((69097761160714285773 : Rat) / 25000000000000000000) = block274RightR)

theorem block274RightChainCertificate_eq_true :
    block274RightChainCertificate = true := by
  native_decide

def block274LeftBoxCount : Nat := boxCount block274LeftBoxes
def block274RightBoxCount : Nat := 78

def block274_rational_certificate : Prop :=
    block274LeftCertificate = true /\
    block274RightChainCertificate = true /\
    block274RightChunk000Certificate = true

theorem block274_rational_certificate_proof :
    block274_rational_certificate := by
  exact ⟨block274LeftCertificate_eq_true, block274RightChainCertificate_eq_true, block274RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block274.block274V
#check Erdos1038Lean.M1817475.Block274.block274_left_V_pos
#check Erdos1038Lean.M1817475.Block274.block274_right_V_pos
#check Erdos1038Lean.M1817475.Block274.block274_reallog_certificate_proof
