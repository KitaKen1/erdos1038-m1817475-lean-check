...
Block 128 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block128RightChunk000 : List RatBox := [
  ...
  { w1 := ((6400915321647589 : Rat) / 2500000000000000), w2 := (0 : Rat), w3 := ((640703723010551 : Rat) / 6250000000000000), w4 := ((6972934541529449 : Rat) / 50000000000000000), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((136751561696428571297 : Rat) / 50000000000000000000), s4 := ((27844905749999999 : Rat) / 10000000000000000), L := ((27844905749999999 : Rat) / 10000000000000000), R := ((1090801618303571429 : Rat) / 390625000000000000), D0 := ((1090801618303571429 : Rat) / 390625000000000000), D1 := ((380850407366071429 : Rat) / 390625000000000000), D2 := ((91608258928571429 : Rat) / 390625000000000000), D3 := ((574209089285714323 : Rat) / 10000000000000000000), D4 := ((49759799107143489 : Rat) / 6250000000000000000), LB := ((187630716627889 : Rat) / 40000000000000000) }
]

def block128RightChunk000L : Rat := ((89612832589285714341 : Rat) / 50000000000000000000)
def block128RightChunk000R : Rat := ((1090801618303571429 : Rat) / 390625000000000000)

def block128RightChunk000Certificate : Bool :=
  allBoxesValid block128RightChunk000 &&
  coversFromBool block128RightChunk000 block128RightChunk000L block128RightChunk000R

theorem block128RightChunk000Certificate_eq_true :
    block128RightChunk000Certificate = true := by
  native_decide

def block128RightChainCertificate : Bool :=
  decide (
    block128RightL = ((89612832589285714341 : Rat) / 50000000000000000000) /\
    ((1090801618303571429 : Rat) / 390625000000000000) = block128RightR)

theorem block128RightChainCertificate_eq_true :
    block128RightChainCertificate = true := by
  native_decide

def block128LeftBoxCount : Nat := boxCount block128LeftBoxes
def block128RightBoxCount : Nat := 50

def block128_rational_certificate : Prop :=
    block128LeftCertificate = true /\
    block128RightChainCertificate = true /\
    block128RightChunk000Certificate = true

theorem block128_rational_certificate_proof :
    block128_rational_certificate := by
  exact ⟨block128LeftCertificate_eq_true, block128RightChainCertificate_eq_true, block128RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block128.block128V
#check Erdos1038Lean.M1817475.Block128.block128_left_V_pos
#check Erdos1038Lean.M1817475.Block128.block128_right_V_pos
#check Erdos1038Lean.M1817475.Block128.block128_reallog_certificate_proof
