...
Block 303 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block303LeftL : Rat := ((2368892857142857151 : Rat) / 3125000000000000000)
def block303LeftR : Rat := ((37912060267857142987 : Rat) / 50000000000000000000)
def block303RightL : Rat := ((5493892857142857151 : Rat) / 3125000000000000000)
def block303RightR : Rat := ((137912060267857142987 : Rat) / 50000000000000000000)

def block303LeftBoxes : List RatBox := [
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((2368892857142857151 : Rat) / 3125000000000000000), R := ((37912060267857142987 : Rat) / 50000000000000000000), D0 := ((37912060267857142987 : Rat) / 50000000000000000000), D1 := ((3310716830357142849 : Rat) / 3125000000000000000), D2 := ((5624654017857142849 : Rat) / 3125000000000000000), D3 := ((98145508124999999769 : Rat) / 50000000000000000000), D4 := ((50964132678571425993 : Rat) / 25000000000000000000), LB := ((4519888132524297 : Rat) / 500000000000000000) }
]

def block303LeftCertificate : Bool :=
  allBoxesValid block303LeftBoxes &&
  coversFromBool block303LeftBoxes block303LeftL block303LeftR

theorem block303LeftCertificate_eq_true :
    block303LeftCertificate = true := by
  native_decide

def block303RightChunk000 : List RatBox := [
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((5493892857142857151 : Rat) / 3125000000000000000), R := ((18174751 : Rat) / 10000000), D0 := ((18174751 : Rat) / 10000000), D1 := ((185716830357142849 : Rat) / 3125000000000000000), D2 := ((2499654017857142849 : Rat) / 3125000000000000000), D3 := ((48145508124999999769 : Rat) / 50000000000000000000), D4 := ((25964132678571425993 : Rat) / 25000000000000000000), LB := ((693762949132547 : Rat) / 312500000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((18174751 : Rat) / 10000000), R := ((43754101 : Rat) / 20000000), D0 := ((43754101 : Rat) / 20000000), D1 := ((7404599 : Rat) / 20000000), D2 := ((7404599 : Rat) / 10000000), D3 := ((9034807767857142837 : Rat) / 10000000000000000000), D4 := ((24478398035714283201 : Rat) / 25000000000000000000), LB := ((6092206171571847 : Rat) / 25000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((43754101 : Rat) / 20000000), R := ((182421003 : Rat) / 80000000), D0 := ((182421003 : Rat) / 80000000), D1 := ((7404599 : Rat) / 16000000), D2 := ((7404599 : Rat) / 20000000), D3 := ((5332508267857142837 : Rat) / 10000000000000000000), D4 := ((15222649285714283201 : Rat) / 25000000000000000000), LB := ((1575945203583773 : Rat) / 10000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((182421003 : Rat) / 80000000), R := ((94912801 : Rat) / 40000000), D0 := ((94912801 : Rat) / 40000000), D1 := ((22213797 : Rat) / 40000000), D2 := ((22213797 : Rat) / 80000000), D3 := ((4406933392857142837 : Rat) / 10000000000000000000), D4 := ((12908712098214283201 : Rat) / 25000000000000000000), LB := ((3567821806856053 : Rat) / 1250000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((94912801 : Rat) / 40000000), R := ((766707007 : Rat) / 320000000), D0 := ((766707007 : Rat) / 320000000), D1 := ((7404599 : Rat) / 12800000), D2 := ((7404599 : Rat) / 40000000), D3 := ((3481358517857142837 : Rat) / 10000000000000000000), D4 := ((10594774910714283201 : Rat) / 25000000000000000000), LB := ((7277349271685829 : Rat) / 200000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((766707007 : Rat) / 320000000), R := ((387055803 : Rat) / 160000000), D0 := ((387055803 : Rat) / 160000000), D1 := ((96259787 : Rat) / 160000000), D2 := ((51832193 : Rat) / 320000000), D3 := ((3249964799107142837 : Rat) / 10000000000000000000), D4 := ((10016290613839283201 : Rat) / 25000000000000000000), LB := ((13105441946082041 : Rat) / 1000000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((387055803 : Rat) / 160000000), R := ((1555627811 : Rat) / 640000000), D0 := ((1555627811 : Rat) / 640000000), D1 := ((392443747 : Rat) / 640000000), D2 := ((22213797 : Rat) / 160000000), D3 := ((3018571080357142837 : Rat) / 10000000000000000000), D4 := ((9437806316964283201 : Rat) / 25000000000000000000), LB := ((4261708394224531 : Rat) / 250000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1555627811 : Rat) / 640000000), R := ((156303241 : Rat) / 64000000), D0 := ((156303241 : Rat) / 64000000), D1 := ((199924173 : Rat) / 320000000), D2 := ((81450589 : Rat) / 640000000), D3 := ((2902874220982142837 : Rat) / 10000000000000000000), D4 := ((9148564168526783201 : Rat) / 25000000000000000000), LB := ((8651579570367829 : Rat) / 1000000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((156303241 : Rat) / 64000000), R := ((1570437009 : Rat) / 640000000), D0 := ((1570437009 : Rat) / 640000000), D1 := ((81450589 : Rat) / 128000000), D2 := ((7404599 : Rat) / 64000000), D3 := ((2787177361607142837 : Rat) / 10000000000000000000), D4 := ((8859322020089283201 : Rat) / 25000000000000000000), LB := ((3657560461890197 : Rat) / 2500000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1570437009 : Rat) / 640000000), R := ((3148278617 : Rat) / 1280000000), D0 := ((3148278617 : Rat) / 1280000000), D1 := ((821910489 : Rat) / 1280000000), D2 := ((66641391 : Rat) / 640000000), D3 := ((2671480502232142837 : Rat) / 10000000000000000000), D4 := ((8570079871651783201 : Rat) / 25000000000000000000), LB := ((6825630915626157 : Rat) / 1000000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3148278617 : Rat) / 1280000000), R := ((197230201 : Rat) / 80000000), D0 := ((197230201 : Rat) / 80000000), D1 := ((51832193 : Rat) / 80000000), D2 := ((125878183 : Rat) / 1280000000), D3 := ((2613632072544642837 : Rat) / 10000000000000000000), D4 := ((8425458797433033201 : Rat) / 25000000000000000000), LB := ((4345313720912569 : Rat) / 1000000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((197230201 : Rat) / 80000000), R := ((632617563 : Rat) / 256000000), D0 := ((632617563 : Rat) / 256000000), D1 := ((836719687 : Rat) / 1280000000), D2 := ((7404599 : Rat) / 80000000), D3 := ((2555783642857142837 : Rat) / 10000000000000000000), D4 := ((8280837723214283201 : Rat) / 25000000000000000000), LB := ((22555257832124753 : Rat) / 10000000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((632617563 : Rat) / 256000000), R := ((1585246207 : Rat) / 640000000), D0 := ((1585246207 : Rat) / 640000000), D1 := ((422062143 : Rat) / 640000000), D2 := ((22213797 : Rat) / 256000000), D3 := ((2497935213169642837 : Rat) / 10000000000000000000), D4 := ((8136216648995533201 : Rat) / 25000000000000000000), LB := ((2917107665012797 : Rat) / 5000000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1585246207 : Rat) / 640000000), R := ((6348389427 : Rat) / 2560000000), D0 := ((6348389427 : Rat) / 2560000000), D1 := ((1695653171 : Rat) / 2560000000), D2 := ((51832193 : Rat) / 640000000), D3 := ((2440086783482142837 : Rat) / 10000000000000000000), D4 := ((7991595574776783201 : Rat) / 25000000000000000000), LB := ((4842823455767309 : Rat) / 1000000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6348389427 : Rat) / 2560000000), R := ((3177897013 : Rat) / 1280000000), D0 := ((3177897013 : Rat) / 1280000000), D1 := ((170305777 : Rat) / 256000000), D2 := ((199924173 : Rat) / 2560000000), D3 := ((2411162568638392837 : Rat) / 10000000000000000000), D4 := ((7919285037667408201 : Rat) / 25000000000000000000), LB := ((175689929625511 : Rat) / 40000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3177897013 : Rat) / 1280000000), R := ((50905589 : Rat) / 20480000), D0 := ((50905589 : Rat) / 20480000), D1 := ((1710462369 : Rat) / 2560000000), D2 := ((96259787 : Rat) / 1280000000), D3 := ((2382238353794642837 : Rat) / 10000000000000000000), D4 := ((7846974500558033201 : Rat) / 25000000000000000000), LB := ((8139018447214097 : Rat) / 2000000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((50905589 : Rat) / 20480000), R := ((796325403 : Rat) / 320000000), D0 := ((796325403 : Rat) / 320000000), D1 := ((214733371 : Rat) / 320000000), D2 := ((7404599 : Rat) / 102400000), D3 := ((2353314138950892837 : Rat) / 10000000000000000000), D4 := ((7774663963448658201 : Rat) / 25000000000000000000), LB := ((19404050619223623 : Rat) / 5000000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((796325403 : Rat) / 320000000), R := ((6378007823 : Rat) / 2560000000), D0 := ((6378007823 : Rat) / 2560000000), D1 := ((1725271567 : Rat) / 2560000000), D2 := ((22213797 : Rat) / 320000000), D3 := ((2324389924107142837 : Rat) / 10000000000000000000), D4 := ((7702353426339283201 : Rat) / 25000000000000000000), LB := ((479132054464447 : Rat) / 125000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6378007823 : Rat) / 2560000000), R := ((3192706211 : Rat) / 1280000000), D0 := ((3192706211 : Rat) / 1280000000), D1 := ((866338083 : Rat) / 1280000000), D2 := ((170305777 : Rat) / 2560000000), D3 := ((2295465709263392837 : Rat) / 10000000000000000000), D4 := ((7630042889229908201 : Rat) / 25000000000000000000), LB := ((983492590465443 : Rat) / 250000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3192706211 : Rat) / 1280000000), R := ((6392817021 : Rat) / 2560000000), D0 := ((6392817021 : Rat) / 2560000000), D1 := ((348016153 : Rat) / 512000000), D2 := ((81450589 : Rat) / 1280000000), D3 := ((2266541494419642837 : Rat) / 10000000000000000000), D4 := ((7557732352120533201 : Rat) / 25000000000000000000), LB := ((8384462079507049 : Rat) / 2000000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6392817021 : Rat) / 2560000000), R := ((320011081 : Rat) / 128000000), D0 := ((320011081 : Rat) / 128000000), D1 := ((436871341 : Rat) / 640000000), D2 := ((155496579 : Rat) / 2560000000), D3 := ((2237617279575892837 : Rat) / 10000000000000000000), D4 := ((7485421815011158201 : Rat) / 25000000000000000000), LB := ((923529421101843 : Rat) / 200000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((320011081 : Rat) / 128000000), R := ((6407626219 : Rat) / 2560000000), D0 := ((6407626219 : Rat) / 2560000000), D1 := ((1754889963 : Rat) / 2560000000), D2 := ((7404599 : Rat) / 128000000), D3 := ((2208693064732142837 : Rat) / 10000000000000000000), D4 := ((7413111277901783201 : Rat) / 25000000000000000000), LB := ((326335690320749 : Rat) / 62500000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6407626219 : Rat) / 2560000000), R := ((3207515409 : Rat) / 1280000000), D0 := ((3207515409 : Rat) / 1280000000), D1 := ((881147281 : Rat) / 1280000000), D2 := ((140687381 : Rat) / 2560000000), D3 := ((2179768849888392837 : Rat) / 10000000000000000000), D4 := ((7340800740792408201 : Rat) / 25000000000000000000), LB := ((300808408912287 : Rat) / 50000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3207515409 : Rat) / 1280000000), R := ((401865001 : Rat) / 160000000), D0 := ((401865001 : Rat) / 160000000), D1 := ((22213797 : Rat) / 32000000), D2 := ((66641391 : Rat) / 1280000000), D3 := ((2150844635044642837 : Rat) / 10000000000000000000), D4 := ((7268490203683033201 : Rat) / 25000000000000000000), LB := ((345771394778549 : Rat) / 200000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((401865001 : Rat) / 160000000), R := ((3222324607 : Rat) / 1280000000), D0 := ((3222324607 : Rat) / 1280000000), D1 := ((895956479 : Rat) / 1280000000), D2 := ((7404599 : Rat) / 160000000), D3 := ((2092996205357142837 : Rat) / 10000000000000000000), D4 := ((7123869129464283201 : Rat) / 25000000000000000000), LB := ((22278628360196673 : Rat) / 5000000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3222324607 : Rat) / 1280000000), R := ((1614864603 : Rat) / 640000000), D0 := ((1614864603 : Rat) / 640000000), D1 := ((451680539 : Rat) / 640000000), D2 := ((51832193 : Rat) / 1280000000), D3 := ((2035147775669642837 : Rat) / 10000000000000000000), D4 := ((6979248055245533201 : Rat) / 25000000000000000000), LB := ((1650770256330003 : Rat) / 200000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1614864603 : Rat) / 640000000), R := ((811134601 : Rat) / 320000000), D0 := ((811134601 : Rat) / 320000000), D1 := ((229542569 : Rat) / 320000000), D2 := ((22213797 : Rat) / 640000000), D3 := ((1977299345982142837 : Rat) / 10000000000000000000), D4 := ((6834626981026783201 : Rat) / 25000000000000000000), LB := ((6148723348613827 : Rat) / 2000000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((811134601 : Rat) / 320000000), R := ((1629673801 : Rat) / 640000000), D0 := ((1629673801 : Rat) / 640000000), D1 := ((466489737 : Rat) / 640000000), D2 := ((7404599 : Rat) / 320000000), D3 := ((1861602486607142837 : Rat) / 10000000000000000000), D4 := ((6545384832589283201 : Rat) / 25000000000000000000), LB := ((154178008469537 : Rat) / 8000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1629673801 : Rat) / 640000000), R := ((511587 : Rat) / 200000), D0 := ((511587 : Rat) / 200000), D1 := ((7404599 : Rat) / 10000000), D2 := ((7404599 : Rat) / 640000000), D3 := ((1745905627232142837 : Rat) / 10000000000000000000), D4 := ((6256142684151783201 : Rat) / 25000000000000000000), LB := ((1281602791417083 : Rat) / 25000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((511587 : Rat) / 200000), R := ((206265008767857142837 : Rat) / 80000000000000000000), D0 := ((206265008767857142837 : Rat) / 80000000000000000000), D1 := ((60867000767857142837 : Rat) / 80000000000000000000), D2 := ((1630208767857142837 : Rat) / 80000000000000000000), D3 := ((1630208767857142837 : Rat) / 10000000000000000000), D4 := ((5966900535714283201 : Rat) / 25000000000000000000), LB := ((5060014136183 : Rat) / 800000000000000) },
  ...
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((52788908767857142837 : Rat) / 20000000000000000000), R := ((423941478910714285533 : Rat) / 160000000000000000000), D0 := ((423941478910714285533 : Rat) / 160000000000000000000), D1 := ((133145462910714285533 : Rat) / 160000000000000000000), D2 := ((14671878910714285533 : Rat) / 160000000000000000000), D3 := ((1630208767857142837 : Rat) / 20000000000000000000), D4 := ((15716558303571418619 : Rat) / 100000000000000000000), LB := ((2345333344561107 : Rat) / 5000000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((423941478910714285533 : Rat) / 160000000000000000000), R := ((42557168767857142837 : Rat) / 16000000000000000000), D0 := ((42557168767857142837 : Rat) / 16000000000000000000), D1 := ((13477567167857142837 : Rat) / 16000000000000000000), D2 := ((1630208767857142837 : Rat) / 16000000000000000000), D3 := ((11411461374999999859 : Rat) / 160000000000000000000), D4 := ((117581422589285634767 : Rat) / 800000000000000000000), LB := ((3773001380265817 : Rat) / 250000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((42557168767857142837 : Rat) / 16000000000000000000), R := ((107208026303571428511 : Rat) / 40000000000000000000), D0 := ((107208026303571428511 : Rat) / 40000000000000000000), D1 := ((34509022303571428511 : Rat) / 40000000000000000000), D2 := ((4890626303571428511 : Rat) / 40000000000000000000), D3 := ((4890626303571428511 : Rat) / 80000000000000000000), D4 := ((54715189374999960291 : Rat) / 400000000000000000000), LB := ((99707210950023 : Rat) / 6250000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((107208026303571428511 : Rat) / 40000000000000000000), R := ((27209558767857142837 : Rat) / 10000000000000000000), D0 := ((27209558767857142837 : Rat) / 10000000000000000000), D1 := ((9034807767857142837 : Rat) / 10000000000000000000), D2 := ((1630208767857142837 : Rat) / 10000000000000000000), D3 := ((1630208767857142837 : Rat) / 40000000000000000000), D4 := ((23282072767857123053 : Rat) / 200000000000000000000), LB := ((9884739155351041 : Rat) / 200000000000000000) },
  { w1 := ((990483898358703 : Rat) / 1000000000000000), w2 := ((12593550145457249 : Rat) / 250000000000000000), w3 := ((268266814304319 : Rat) / 1000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((27209558767857142837 : Rat) / 10000000000000000000), R := ((137912060267857142987 : Rat) / 50000000000000000000), D0 := ((137912060267857142987 : Rat) / 50000000000000000000), D1 := ((47038305267857142987 : Rat) / 50000000000000000000), D2 := ((10015310267857142987 : Rat) / 50000000000000000000), D3 := ((932133214285714401 : Rat) / 25000000000000000000), D4 := ((3782757232142852217 : Rat) / 50000000000000000000), LB := ((92547523087263 : Rat) / 10000000000000000) }
]

def block303RightChunk000L : Rat := ((5493892857142857151 : Rat) / 3125000000000000000)
def block303RightChunk000R : Rat := ((137912060267857142987 : Rat) / 50000000000000000000)

def block303RightChunk000Certificate : Bool :=
  allBoxesValid block303RightChunk000 &&
  coversFromBool block303RightChunk000 block303RightChunk000L block303RightChunk000R

theorem block303RightChunk000Certificate_eq_true :
    block303RightChunk000Certificate = true := by
  native_decide

def block303RightChainCertificate : Bool :=
  decide (
    block303RightL = ((5493892857142857151 : Rat) / 3125000000000000000) /\
    ((137912060267857142987 : Rat) / 50000000000000000000) = block303RightR)

theorem block303RightChainCertificate_eq_true :
    block303RightChainCertificate = true := by
  native_decide

def block303LeftBoxCount : Nat := boxCount block303LeftBoxes
def block303RightBoxCount : Nat := 51

def block303_rational_certificate : Prop :=
    block303LeftCertificate = true /\
    block303RightChainCertificate = true /\
    block303RightChunk000Certificate = true

theorem block303_rational_certificate_proof :
    block303_rational_certificate := by
  exact ⟨block303LeftCertificate_eq_true, block303RightChainCertificate_eq_true, block303RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block303.block303V
#check Erdos1038Lean.M1817475.Block303.block303_left_V_pos
#check Erdos1038Lean.M1817475.Block303.block303_right_V_pos
#check Erdos1038Lean.M1817475.Block303.block303_reallog_certificate_proof
