...
Block 131 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block131RightChunk000 : List RatBox := [
  ...
  { w1 := ((25485852585364293 : Rat) / 10000000000000000), w2 := (0 : Rat), w3 := ((10739714228807083 : Rat) / 100000000000000000), w4 := ((13393713001581653 : Rat) / 100000000000000000), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((136751561696428571297 : Rat) / 50000000000000000000), s4 := ((27844905749999999 : Rat) / 10000000000000000), L := ((27844905749999999 : Rat) / 10000000000000000), R := ((139593283482142857199 : Rat) / 50000000000000000000), D0 := ((139593283482142857199 : Rat) / 50000000000000000000), D1 := ((48719528482142857199 : Rat) / 50000000000000000000), D2 := ((11696533482142857199 : Rat) / 50000000000000000000), D3 := ((1420860892857142951 : Rat) / 25000000000000000000), D4 := ((368754732142862199 : Rat) / 50000000000000000000), LB := ((4661813583544339 : Rat) / 1000000000000000000) }
]

def block131RightChunk000L : Rat := ((22395877232142857157 : Rat) / 12500000000000000000)
def block131RightChunk000R : Rat := ((139593283482142857199 : Rat) / 50000000000000000000)

def block131RightChunk000Certificate : Bool :=
  allBoxesValid block131RightChunk000 &&
  coversFromBool block131RightChunk000 block131RightChunk000L block131RightChunk000R

theorem block131RightChunk000Certificate_eq_true :
    block131RightChunk000Certificate = true := by
  native_decide

def block131RightChainCertificate : Bool :=
  decide (
    block131RightL = ((22395877232142857157 : Rat) / 12500000000000000000) /\
    ((139593283482142857199 : Rat) / 50000000000000000000) = block131RightR)

theorem block131RightChainCertificate_eq_true :
    block131RightChainCertificate = true := by
  native_decide

def block131LeftBoxCount : Nat := boxCount block131LeftBoxes
def block131RightBoxCount : Nat := 50

def block131_rational_certificate : Prop :=
    block131LeftCertificate = true /\
    block131RightChainCertificate = true /\
    block131RightChunk000Certificate = true

theorem block131_rational_certificate_proof :
    block131_rational_certificate := by
  exact ⟨block131LeftCertificate_eq_true, block131RightChainCertificate_eq_true, block131RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block131.block131V
#check Erdos1038Lean.M1817475.Block131.block131_left_V_pos
#check Erdos1038Lean.M1817475.Block131.block131_right_V_pos
#check Erdos1038Lean.M1817475.Block131.block131_reallog_certificate_proof
