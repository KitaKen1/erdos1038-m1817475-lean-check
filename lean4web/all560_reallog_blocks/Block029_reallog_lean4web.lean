...
Block 29 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block029RightChunk000 : List RatBox := [
  ...
  { w1 := ((943420885535261 : Rat) / 400000000000000), w2 := (0 : Rat), w3 := (0 : Rat), w4 := ((5679509817629097 : Rat) / 20000000000000000), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((107000619 : Rat) / 40000000), s4 := ((27844905749999999 : Rat) / 10000000000000000), L := ((27844905749999999 : Rat) / 10000000000000000), R := ((140590287946428571441 : Rat) / 50000000000000000000), D0 := ((140590287946428571441 : Rat) / 50000000000000000000), D1 := ((49716532946428571441 : Rat) / 50000000000000000000), D2 := ((12693537946428571441 : Rat) / 50000000000000000000), D3 := ((6839514196428571441 : Rat) / 50000000000000000000), D4 := ((1365759196428576441 : Rat) / 50000000000000000000), LB := ((19831092711373177 : Rat) / 10000000000000000000) }
]

def block029RightChunk000L : Rat := ((9058051339285714287 : Rat) / 5000000000000000000)
def block029RightChunk000R : Rat := ((140590287946428571441 : Rat) / 50000000000000000000)

def block029RightChunk000Certificate : Bool :=
  allBoxesValid block029RightChunk000 &&
  coversFromBool block029RightChunk000 block029RightChunk000L block029RightChunk000R

theorem block029RightChunk000Certificate_eq_true :
    block029RightChunk000Certificate = true := by
  native_decide

def block029RightChainCertificate : Bool :=
  decide (
    block029RightL = ((9058051339285714287 : Rat) / 5000000000000000000) /\
    ((140590287946428571441 : Rat) / 50000000000000000000) = block029RightR)

theorem block029RightChainCertificate_eq_true :
    block029RightChainCertificate = true := by
  native_decide

def block029LeftBoxCount : Nat := boxCount block029LeftBoxes
def block029RightBoxCount : Nat := 77

def block029_rational_certificate : Prop :=
    block029LeftCertificate = true /\
    block029RightChainCertificate = true /\
    block029RightChunk000Certificate = true

theorem block029_rational_certificate_proof :
    block029_rational_certificate := by
  exact ⟨block029LeftCertificate_eq_true, block029RightChainCertificate_eq_true, block029RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block029.block029V
#check Erdos1038Lean.M1817475.Block029.block029_left_V_pos
#check Erdos1038Lean.M1817475.Block029.block029_right_V_pos
#check Erdos1038Lean.M1817475.Block029.block029_reallog_certificate_proof
