...
Block 290 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block290LeftL : Rat := ((38029354910714285839 : Rat) / 50000000000000000000)
def block290LeftR : Rat := ((3803912946428571441 : Rat) / 5000000000000000000)
def block290RightL : Rat := ((88029354910714285839 : Rat) / 50000000000000000000)
def block290RightR : Rat := ((13803912946428571441 : Rat) / 5000000000000000000)

def block290LeftBoxes : List RatBox := [
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((38029354910714285839 : Rat) / 50000000000000000000), R := ((3803912946428571441 : Rat) / 5000000000000000000), D0 := ((3803912946428571441 : Rat) / 5000000000000000000), D1 := ((52844400089285714161 : Rat) / 50000000000000000000), D2 := ((89867395089285714161 : Rat) / 50000000000000000000), D3 := ((49009219464285714173 : Rat) / 25000000000000000000), D4 := ((101801196160714280563 : Rat) / 50000000000000000000), LB := ((380800204027169 : Rat) / 62500000000000000) }
]

def block290LeftCertificate : Bool :=
  allBoxesValid block290LeftBoxes &&
  coversFromBool block290LeftBoxes block290LeftL block290LeftR

theorem block290LeftCertificate_eq_true :
    block290LeftCertificate = true := by
  native_decide

def block290RightChunk000 : List RatBox := [
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((88029354910714285839 : Rat) / 50000000000000000000), R := ((18174751 : Rat) / 10000000), D0 := ((18174751 : Rat) / 10000000), D1 := ((2844400089285714161 : Rat) / 50000000000000000000), D2 := ((39867395089285714161 : Rat) / 50000000000000000000), D3 := ((24009219464285714173 : Rat) / 25000000000000000000), D4 := ((51801196160714280563 : Rat) / 50000000000000000000), LB := ((2366562714366419 : Rat) / 1000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((18174751 : Rat) / 10000000), R := ((43754101 : Rat) / 20000000), D0 := ((43754101 : Rat) / 20000000), D1 := ((7404599 : Rat) / 20000000), D2 := ((7404599 : Rat) / 10000000), D3 := ((9034807767857142837 : Rat) / 10000000000000000000), D4 := ((24478398035714283201 : Rat) / 25000000000000000000), LB := ((27740944489242797 : Rat) / 100000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((43754101 : Rat) / 20000000), R := ((182421003 : Rat) / 80000000), D0 := ((182421003 : Rat) / 80000000), D1 := ((7404599 : Rat) / 16000000), D2 := ((7404599 : Rat) / 20000000), D3 := ((5332508267857142837 : Rat) / 10000000000000000000), D4 := ((15222649285714283201 : Rat) / 25000000000000000000), LB := ((3611176746309857 : Rat) / 20000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((182421003 : Rat) / 80000000), R := ((94912801 : Rat) / 40000000), D0 := ((94912801 : Rat) / 40000000), D1 := ((22213797 : Rat) / 40000000), D2 := ((22213797 : Rat) / 80000000), D3 := ((4406933392857142837 : Rat) / 10000000000000000000), D4 := ((12908712098214283201 : Rat) / 25000000000000000000), LB := ((17756771681603473 : Rat) / 1000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((94912801 : Rat) / 40000000), R := ((766707007 : Rat) / 320000000), D0 := ((766707007 : Rat) / 320000000), D1 := ((7404599 : Rat) / 12800000), D2 := ((7404599 : Rat) / 40000000), D3 := ((3481358517857142837 : Rat) / 10000000000000000000), D4 := ((10594774910714283201 : Rat) / 25000000000000000000), LB := ((2965483420662671 : Rat) / 62500000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((766707007 : Rat) / 320000000), R := ((387055803 : Rat) / 160000000), D0 := ((387055803 : Rat) / 160000000), D1 := ((96259787 : Rat) / 160000000), D2 := ((51832193 : Rat) / 320000000), D3 := ((3249964799107142837 : Rat) / 10000000000000000000), D4 := ((10016290613839283201 : Rat) / 25000000000000000000), LB := ((2185899209049369 : Rat) / 100000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((387055803 : Rat) / 160000000), R := ((156303241 : Rat) / 64000000), D0 := ((156303241 : Rat) / 64000000), D1 := ((199924173 : Rat) / 320000000), D2 := ((22213797 : Rat) / 160000000), D3 := ((3018571080357142837 : Rat) / 10000000000000000000), D4 := ((9437806316964283201 : Rat) / 25000000000000000000), LB := ((8614766335723889 : Rat) / 100000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((156303241 : Rat) / 64000000), R := ((1570437009 : Rat) / 640000000), D0 := ((1570437009 : Rat) / 640000000), D1 := ((81450589 : Rat) / 128000000), D2 := ((7404599 : Rat) / 64000000), D3 := ((2787177361607142837 : Rat) / 10000000000000000000), D4 := ((8859322020089283201 : Rat) / 25000000000000000000), LB := ((1434903997471773 : Rat) / 250000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1570437009 : Rat) / 640000000), R := ((3148278617 : Rat) / 1280000000), D0 := ((3148278617 : Rat) / 1280000000), D1 := ((821910489 : Rat) / 1280000000), D2 := ((66641391 : Rat) / 640000000), D3 := ((2671480502232142837 : Rat) / 10000000000000000000), D4 := ((8570079871651783201 : Rat) / 25000000000000000000), LB := ((1243309567646983 : Rat) / 125000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3148278617 : Rat) / 1280000000), R := ((197230201 : Rat) / 80000000), D0 := ((197230201 : Rat) / 80000000), D1 := ((51832193 : Rat) / 80000000), D2 := ((125878183 : Rat) / 1280000000), D3 := ((2613632072544642837 : Rat) / 10000000000000000000), D4 := ((8425458797433033201 : Rat) / 25000000000000000000), LB := ((1669573881137823 : Rat) / 250000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((197230201 : Rat) / 80000000), R := ((632617563 : Rat) / 256000000), D0 := ((632617563 : Rat) / 256000000), D1 := ((836719687 : Rat) / 1280000000), D2 := ((7404599 : Rat) / 80000000), D3 := ((2555783642857142837 : Rat) / 10000000000000000000), D4 := ((8280837723214283201 : Rat) / 25000000000000000000), LB := ((2353827999271689 : Rat) / 625000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((632617563 : Rat) / 256000000), R := ((1585246207 : Rat) / 640000000), D0 := ((1585246207 : Rat) / 640000000), D1 := ((422062143 : Rat) / 640000000), D2 := ((22213797 : Rat) / 256000000), D3 := ((2497935213169642837 : Rat) / 10000000000000000000), D4 := ((8136216648995533201 : Rat) / 25000000000000000000), LB := ((3079421540131133 : Rat) / 2500000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1585246207 : Rat) / 640000000), R := ((6348389427 : Rat) / 2560000000), D0 := ((6348389427 : Rat) / 2560000000), D1 := ((1695653171 : Rat) / 2560000000), D2 := ((51832193 : Rat) / 640000000), D3 := ((2440086783482142837 : Rat) / 10000000000000000000), D4 := ((7991595574776783201 : Rat) / 25000000000000000000), LB := ((23708654292193543 : Rat) / 5000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6348389427 : Rat) / 2560000000), R := ((3177897013 : Rat) / 1280000000), D0 := ((3177897013 : Rat) / 1280000000), D1 := ((170305777 : Rat) / 256000000), D2 := ((199924173 : Rat) / 2560000000), D3 := ((2411162568638392837 : Rat) / 10000000000000000000), D4 := ((7919285037667408201 : Rat) / 25000000000000000000), LB := ((19081830963862123 : Rat) / 5000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3177897013 : Rat) / 1280000000), R := ((50905589 : Rat) / 20480000), D0 := ((50905589 : Rat) / 20480000), D1 := ((1710462369 : Rat) / 2560000000), D2 := ((96259787 : Rat) / 1280000000), D3 := ((2382238353794642837 : Rat) / 10000000000000000000), D4 := ((7846974500558033201 : Rat) / 25000000000000000000), LB := ((600826990256953 : Rat) / 200000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((50905589 : Rat) / 20480000), R := ((796325403 : Rat) / 320000000), D0 := ((796325403 : Rat) / 320000000), D1 := ((214733371 : Rat) / 320000000), D2 := ((7404599 : Rat) / 102400000), D3 := ((2353314138950892837 : Rat) / 10000000000000000000), D4 := ((7774663963448658201 : Rat) / 25000000000000000000), LB := ((23099387466266053 : Rat) / 10000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((796325403 : Rat) / 320000000), R := ((6378007823 : Rat) / 2560000000), D0 := ((6378007823 : Rat) / 2560000000), D1 := ((1725271567 : Rat) / 2560000000), D2 := ((22213797 : Rat) / 320000000), D3 := ((2324389924107142837 : Rat) / 10000000000000000000), D4 := ((7702353426339283201 : Rat) / 25000000000000000000), LB := ((8696094178731739 : Rat) / 5000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6378007823 : Rat) / 2560000000), R := ((3192706211 : Rat) / 1280000000), D0 := ((3192706211 : Rat) / 1280000000), D1 := ((866338083 : Rat) / 1280000000), D2 := ((170305777 : Rat) / 2560000000), D3 := ((2295465709263392837 : Rat) / 10000000000000000000), D4 := ((7630042889229908201 : Rat) / 25000000000000000000), LB := ((1622554055301581 : Rat) / 1250000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3192706211 : Rat) / 1280000000), R := ((6392817021 : Rat) / 2560000000), D0 := ((6392817021 : Rat) / 2560000000), D1 := ((348016153 : Rat) / 512000000), D2 := ((81450589 : Rat) / 1280000000), D3 := ((2266541494419642837 : Rat) / 10000000000000000000), D4 := ((7557732352120533201 : Rat) / 25000000000000000000), LB := ((4966064937248771 : Rat) / 5000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6392817021 : Rat) / 2560000000), R := ((320011081 : Rat) / 128000000), D0 := ((320011081 : Rat) / 128000000), D1 := ((436871341 : Rat) / 640000000), D2 := ((155496579 : Rat) / 2560000000), D3 := ((2237617279575892837 : Rat) / 10000000000000000000), D4 := ((7485421815011158201 : Rat) / 25000000000000000000), LB := ((1664785399750679 : Rat) / 2000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((320011081 : Rat) / 128000000), R := ((6407626219 : Rat) / 2560000000), D0 := ((6407626219 : Rat) / 2560000000), D1 := ((1754889963 : Rat) / 2560000000), D2 := ((7404599 : Rat) / 128000000), D3 := ((2208693064732142837 : Rat) / 10000000000000000000), D4 := ((7413111277901783201 : Rat) / 25000000000000000000), LB := ((8242727984965059 : Rat) / 10000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6407626219 : Rat) / 2560000000), R := ((3207515409 : Rat) / 1280000000), D0 := ((3207515409 : Rat) / 1280000000), D1 := ((881147281 : Rat) / 1280000000), D2 := ((140687381 : Rat) / 2560000000), D3 := ((2179768849888392837 : Rat) / 10000000000000000000), D4 := ((7340800740792408201 : Rat) / 25000000000000000000), LB := ((391509145847313 : Rat) / 400000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3207515409 : Rat) / 1280000000), R := ((6422435417 : Rat) / 2560000000), D0 := ((6422435417 : Rat) / 2560000000), D1 := ((1769699161 : Rat) / 2560000000), D2 := ((66641391 : Rat) / 1280000000), D3 := ((2150844635044642837 : Rat) / 10000000000000000000), D4 := ((7268490203683033201 : Rat) / 25000000000000000000), LB := ((817062247802057 : Rat) / 625000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6422435417 : Rat) / 2560000000), R := ((401865001 : Rat) / 160000000), D0 := ((401865001 : Rat) / 160000000), D1 := ((22213797 : Rat) / 32000000), D2 := ((125878183 : Rat) / 2560000000), D3 := ((2121920420200892837 : Rat) / 10000000000000000000), D4 := ((7196179666573658201 : Rat) / 25000000000000000000), LB := ((18230780319400397 : Rat) / 10000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((401865001 : Rat) / 160000000), R := ((1287448923 : Rat) / 512000000), D0 := ((1287448923 : Rat) / 512000000), D1 := ((1784508359 : Rat) / 2560000000), D2 := ((7404599 : Rat) / 160000000), D3 := ((2092996205357142837 : Rat) / 10000000000000000000), D4 := ((7123869129464283201 : Rat) / 25000000000000000000), LB := ((1588489178510101 : Rat) / 625000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1287448923 : Rat) / 512000000), R := ((3222324607 : Rat) / 1280000000), D0 := ((3222324607 : Rat) / 1280000000), D1 := ((895956479 : Rat) / 1280000000), D2 := ((22213797 : Rat) / 512000000), D3 := ((2064071990513392837 : Rat) / 10000000000000000000), D4 := ((7051558592354908201 : Rat) / 25000000000000000000), LB := ((3481107300670583 : Rat) / 1000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3222324607 : Rat) / 1280000000), R := ((6452053813 : Rat) / 2560000000), D0 := ((6452053813 : Rat) / 2560000000), D1 := ((1799317557 : Rat) / 2560000000), D2 := ((51832193 : Rat) / 1280000000), D3 := ((2035147775669642837 : Rat) / 10000000000000000000), D4 := ((6979248055245533201 : Rat) / 25000000000000000000), LB := ((4663530640661051 : Rat) / 1000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6452053813 : Rat) / 2560000000), R := ((1614864603 : Rat) / 640000000), D0 := ((1614864603 : Rat) / 640000000), D1 := ((451680539 : Rat) / 640000000), D2 := ((96259787 : Rat) / 2560000000), D3 := ((2006223560825892837 : Rat) / 10000000000000000000), D4 := ((6906937518136158201 : Rat) / 25000000000000000000), LB := ((6115365604259293 : Rat) / 1000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1614864603 : Rat) / 640000000), R := ((647426761 : Rat) / 256000000), D0 := ((647426761 : Rat) / 256000000), D1 := ((910765677 : Rat) / 1280000000), D2 := ((22213797 : Rat) / 640000000), D3 := ((1977299345982142837 : Rat) / 10000000000000000000), D4 := ((6834626981026783201 : Rat) / 25000000000000000000), LB := ((254152361039911 : Rat) / 100000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((647426761 : Rat) / 256000000), R := ((811134601 : Rat) / 320000000), D0 := ((811134601 : Rat) / 320000000), D1 := ((229542569 : Rat) / 320000000), D2 := ((7404599 : Rat) / 256000000), D3 := ((1919450916294642837 : Rat) / 10000000000000000000), D4 := ((6690005906808033201 : Rat) / 25000000000000000000), LB := ((895797534182001 : Rat) / 125000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((811134601 : Rat) / 320000000), R := ((1629673801 : Rat) / 640000000), D0 := ((1629673801 : Rat) / 640000000), D1 := ((466489737 : Rat) / 640000000), D2 := ((7404599 : Rat) / 320000000), D3 := ((1861602486607142837 : Rat) / 10000000000000000000), D4 := ((6545384832589283201 : Rat) / 25000000000000000000), LB := ((6419006946762007 : Rat) / 2000000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1629673801 : Rat) / 640000000), R := ((511587 : Rat) / 200000), D0 := ((511587 : Rat) / 200000), D1 := ((7404599 : Rat) / 10000000), D2 := ((7404599 : Rat) / 640000000), D3 := ((1745905627232142837 : Rat) / 10000000000000000000), D4 := ((6256142684151783201 : Rat) / 25000000000000000000), LB := ((2675799913237281 : Rat) / 100000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((511587 : Rat) / 200000), R := ((410899808767857142837 : Rat) / 160000000000000000000), D0 := ((410899808767857142837 : Rat) / 160000000000000000000), D1 := ((120103792767857142837 : Rat) / 160000000000000000000), D2 := ((1630208767857142837 : Rat) / 160000000000000000000), D3 := ((1630208767857142837 : Rat) / 10000000000000000000), D4 := ((5966900535714283201 : Rat) / 25000000000000000000), LB := ((6547764161257219 : Rat) / 200000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((410899808767857142837 : Rat) / 160000000000000000000), R := ((206265008767857142837 : Rat) / 80000000000000000000), D0 := ((206265008767857142837 : Rat) / 80000000000000000000), D1 := ((60867000767857142837 : Rat) / 80000000000000000000), D2 := ((1630208767857142837 : Rat) / 80000000000000000000), D3 := ((4890626303571428511 : Rat) / 32000000000000000000), D4 := ((182789773303571348247 : Rat) / 800000000000000000000), LB := ((3337177419947157 : Rat) / 500000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((206265008767857142837 : Rat) / 80000000000000000000), R := ((165338048767857142837 : Rat) / 64000000000000000000), D0 := ((165338048767857142837 : Rat) / 64000000000000000000), D1 := ((49019642367857142837 : Rat) / 64000000000000000000), D2 := ((1630208767857142837 : Rat) / 64000000000000000000), D3 := ((11411461374999999859 : Rat) / 80000000000000000000), D4 := ((87319364732142817031 : Rat) / 400000000000000000000), LB := ((1083372522809059 : Rat) / 125000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((165338048767857142837 : Rat) / 64000000000000000000), R := ((414160226303571428511 : Rat) / 160000000000000000000), D0 := ((414160226303571428511 : Rat) / 160000000000000000000), D1 := ((123364210303571428511 : Rat) / 160000000000000000000), D2 := ((4890626303571428511 : Rat) / 160000000000000000000), D3 := ((44015636732142856599 : Rat) / 320000000000000000000), D4 := ((341126415089285553939 : Rat) / 1600000000000000000000), LB := ((627154803354113 : Rat) / 200000000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((414160226303571428511 : Rat) / 160000000000000000000), R := ((1658271113982142856881 : Rat) / 640000000000000000000), D0 := ((1658271113982142856881 : Rat) / 640000000000000000000), D1 := ((495087049982142856881 : Rat) / 640000000000000000000), D2 := ((21192713982142856881 : Rat) / 640000000000000000000), D3 := ((21192713982142856881 : Rat) / 160000000000000000000), D4 := ((166487685624999919877 : Rat) / 800000000000000000000), LB := ((1255851651334039 : Rat) / 200000000000000000) },
  ...
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((107208026303571428511 : Rat) / 40000000000000000000), R := ((27209558767857142837 : Rat) / 10000000000000000000), D0 := ((27209558767857142837 : Rat) / 10000000000000000000), D1 := ((9034807767857142837 : Rat) / 10000000000000000000), D2 := ((1630208767857142837 : Rat) / 10000000000000000000), D3 := ((1630208767857142837 : Rat) / 40000000000000000000), D4 := ((23282072767857123053 : Rat) / 200000000000000000000), LB := ((209384472988303 : Rat) / 3125000000000000) },
  { w1 := ((10270117595800017 : Rat) / 10000000000000000), w2 := ((3796853901458541 : Rat) / 100000000000000000), w3 := ((349541384225821 : Rat) / 1250000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((27209558767857142837 : Rat) / 10000000000000000000), R := ((13803912946428571441 : Rat) / 5000000000000000000), D0 := ((13803912946428571441 : Rat) / 5000000000000000000), D1 := ((4716537446428571441 : Rat) / 5000000000000000000), D2 := ((1014237946428571441 : Rat) / 5000000000000000000), D3 := ((79653425000000009 : Rat) / 2000000000000000000), D4 := ((3782757232142852217 : Rat) / 50000000000000000000), LB := ((3157401256049297 : Rat) / 500000000000000000) }
]

def block290RightChunk000L : Rat := ((88029354910714285839 : Rat) / 50000000000000000000)
def block290RightChunk000R : Rat := ((13803912946428571441 : Rat) / 5000000000000000000)

def block290RightChunk000Certificate : Bool :=
  allBoxesValid block290RightChunk000 &&
  coversFromBool block290RightChunk000 block290RightChunk000L block290RightChunk000R

theorem block290RightChunk000Certificate_eq_true :
    block290RightChunk000Certificate = true := by
  native_decide

def block290RightChainCertificate : Bool :=
  decide (
    block290RightL = ((88029354910714285839 : Rat) / 50000000000000000000) /\
    ((13803912946428571441 : Rat) / 5000000000000000000) = block290RightR)

theorem block290RightChainCertificate_eq_true :
    block290RightChainCertificate = true := by
  native_decide

def block290LeftBoxCount : Nat := boxCount block290LeftBoxes
def block290RightBoxCount : Nat := 58

def block290_rational_certificate : Prop :=
    block290LeftCertificate = true /\
    block290RightChainCertificate = true /\
    block290RightChunk000Certificate = true

theorem block290_rational_certificate_proof :
    block290_rational_certificate := by
  exact ⟨block290LeftCertificate_eq_true, block290RightChainCertificate_eq_true, block290RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block290.block290V
#check Erdos1038Lean.M1817475.Block290.block290_left_V_pos
#check Erdos1038Lean.M1817475.Block290.block290_right_V_pos
#check Erdos1038Lean.M1817475.Block290.block290_reallog_certificate_proof
