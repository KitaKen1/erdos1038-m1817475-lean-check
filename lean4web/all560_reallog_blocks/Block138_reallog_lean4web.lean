...
Block 138 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block138RightChunk000 : List RatBox := [
  ...
  { w1 := ((5047462347975249 : Rat) / 2000000000000000), w2 := (0 : Rat), w3 := ((11879327299912469 : Rat) / 100000000000000000), w4 := ((1512277215407613 : Rat) / 12500000000000000), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((136751561696428571297 : Rat) / 50000000000000000000), s4 := ((27844905749999999 : Rat) / 10000000000000000), L := ((27844905749999999 : Rat) / 10000000000000000), R := ((69762430803571428601 : Rat) / 25000000000000000000), D0 := ((69762430803571428601 : Rat) / 25000000000000000000), D1 := ((24325553303571428601 : Rat) / 25000000000000000000), D2 := ((5814055803571428601 : Rat) / 25000000000000000000), D3 := ((554659982142857181 : Rat) / 10000000000000000000), D4 := ((150166428571431101 : Rat) / 25000000000000000000), LB := ((8834584175275717 : Rat) / 2000000000000000000) }
]

def block138RightChunk000L : Rat := ((89515087053571428631 : Rat) / 50000000000000000000)
def block138RightChunk000R : Rat := ((69762430803571428601 : Rat) / 25000000000000000000)

def block138RightChunk000Certificate : Bool :=
  allBoxesValid block138RightChunk000 &&
  coversFromBool block138RightChunk000 block138RightChunk000L block138RightChunk000R

theorem block138RightChunk000Certificate_eq_true :
    block138RightChunk000Certificate = true := by
  native_decide

def block138RightChainCertificate : Bool :=
  decide (
    block138RightL = ((89515087053571428631 : Rat) / 50000000000000000000) /\
    ((69762430803571428601 : Rat) / 25000000000000000000) = block138RightR)

theorem block138RightChainCertificate_eq_true :
    block138RightChainCertificate = true := by
  native_decide

def block138LeftBoxCount : Nat := boxCount block138LeftBoxes
def block138RightBoxCount : Nat := 55

def block138_rational_certificate : Prop :=
    block138LeftCertificate = true /\
    block138RightChainCertificate = true /\
    block138RightChunk000Certificate = true

theorem block138_rational_certificate_proof :
    block138_rational_certificate := by
  exact ⟨block138LeftCertificate_eq_true, block138RightChainCertificate_eq_true, block138RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block138.block138V
#check Erdos1038Lean.M1817475.Block138.block138_left_V_pos
#check Erdos1038Lean.M1817475.Block138.block138_right_V_pos
#check Erdos1038Lean.M1817475.Block138.block138_reallog_certificate_proof
