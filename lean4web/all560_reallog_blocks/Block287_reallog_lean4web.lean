...
Block 287 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block287RightChunk000 : List RatBox := [
  ...
  { w1 := ((2058087492174479 : Rat) / 2000000000000000), w2 := ((1134904815818323 : Rat) / 31250000000000000), w3 := ((28177492560382167 : Rat) / 100000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((107208026303571428511 : Rat) / 40000000000000000000), R := ((27209558767857142837 : Rat) / 10000000000000000000), D0 := ((27209558767857142837 : Rat) / 10000000000000000000), D1 := ((9034807767857142837 : Rat) / 10000000000000000000), D2 := ((1630208767857142837 : Rat) / 10000000000000000000), D3 := ((1630208767857142837 : Rat) / 40000000000000000000), D4 := ((23282072767857123053 : Rat) / 200000000000000000000), LB := ((7106769235561061 : Rat) / 100000000000000000) },
  { w1 := ((2058087492174479 : Rat) / 2000000000000000), w2 := ((1134904815818323 : Rat) / 31250000000000000), w3 := ((28177492560382167 : Rat) / 100000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((27209558767857142837 : Rat) / 10000000000000000000), R := ((138068453125000000123 : Rat) / 50000000000000000000), D0 := ((138068453125000000123 : Rat) / 50000000000000000000), D1 := ((47194698125000000123 : Rat) / 50000000000000000000), D2 := ((10171703125000000123 : Rat) / 50000000000000000000), D3 := ((1010329642857142969 : Rat) / 25000000000000000000), D4 := ((3782757232142852217 : Rat) / 50000000000000000000), LB := ((11252550573863429 : Rat) / 2000000000000000000) }
]

def block287RightChunk000L : Rat := ((2751833705357142861 : Rat) / 1562500000000000000)
def block287RightChunk000R : Rat := ((138068453125000000123 : Rat) / 50000000000000000000)

def block287RightChunk000Certificate : Bool :=
  allBoxesValid block287RightChunk000 &&
  coversFromBool block287RightChunk000 block287RightChunk000L block287RightChunk000R

theorem block287RightChunk000Certificate_eq_true :
    block287RightChunk000Certificate = true := by
  native_decide

def block287RightChainCertificate : Bool :=
  decide (
    block287RightL = ((2751833705357142861 : Rat) / 1562500000000000000) /\
    ((138068453125000000123 : Rat) / 50000000000000000000) = block287RightR)

theorem block287RightChainCertificate_eq_true :
    block287RightChainCertificate = true := by
  native_decide

def block287LeftBoxCount : Nat := boxCount block287LeftBoxes
def block287RightBoxCount : Nat := 58

def block287_rational_certificate : Prop :=
    block287LeftCertificate = true /\
    block287RightChainCertificate = true /\
    block287RightChunk000Certificate = true

theorem block287_rational_certificate_proof :
    block287_rational_certificate := by
  exact ⟨block287LeftCertificate_eq_true, block287RightChainCertificate_eq_true, block287RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block287.block287V
#check Erdos1038Lean.M1817475.Block287.block287_left_V_pos
#check Erdos1038Lean.M1817475.Block287.block287_right_V_pos
#check Erdos1038Lean.M1817475.Block287.block287_reallog_certificate_proof
