...
Block 292 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block292LeftL : Rat := ((38009805803571428697 : Rat) / 50000000000000000000)
def block292LeftR : Rat := ((9504895089285714317 : Rat) / 12500000000000000000)
def block292RightL : Rat := ((88009805803571428697 : Rat) / 50000000000000000000)
def block292RightR : Rat := ((34504895089285714317 : Rat) / 12500000000000000000)

def block292LeftBoxes : List RatBox := [
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((38009805803571428697 : Rat) / 50000000000000000000), R := ((9504895089285714317 : Rat) / 12500000000000000000), D0 := ((9504895089285714317 : Rat) / 12500000000000000000), D1 := ((52863949196428571303 : Rat) / 50000000000000000000), D2 := ((89886944196428571303 : Rat) / 50000000000000000000), D3 := ((6127374252232142843 : Rat) / 3125000000000000000), D4 := ((20364149053571427541 : Rat) / 10000000000000000000), LB := ((3275846596770493 : Rat) / 500000000000000000) }
]

def block292LeftCertificate : Bool :=
  allBoxesValid block292LeftBoxes &&
  coversFromBool block292LeftBoxes block292LeftL block292LeftR

theorem block292LeftCertificate_eq_true :
    block292LeftCertificate = true := by
  native_decide

def block292RightChunk000 : List RatBox := [
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((88009805803571428697 : Rat) / 50000000000000000000), R := ((18174751 : Rat) / 10000000), D0 := ((18174751 : Rat) / 10000000), D1 := ((2863949196428571303 : Rat) / 50000000000000000000), D2 := ((39886944196428571303 : Rat) / 50000000000000000000), D3 := ((3002374252232142843 : Rat) / 3125000000000000000), D4 := ((10364149053571427541 : Rat) / 10000000000000000000), LB := ((5859646465021151 : Rat) / 2500000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((18174751 : Rat) / 10000000), R := ((43754101 : Rat) / 20000000), D0 := ((43754101 : Rat) / 20000000), D1 := ((7404599 : Rat) / 20000000), D2 := ((7404599 : Rat) / 10000000), D3 := ((9034807767857142837 : Rat) / 10000000000000000000), D4 := ((24478398035714283201 : Rat) / 25000000000000000000), LB := ((2722676876249763 : Rat) / 10000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((43754101 : Rat) / 20000000), R := ((182421003 : Rat) / 80000000), D0 := ((182421003 : Rat) / 80000000), D1 := ((7404599 : Rat) / 16000000), D2 := ((7404599 : Rat) / 20000000), D3 := ((5332508267857142837 : Rat) / 10000000000000000000), D4 := ((15222649285714283201 : Rat) / 25000000000000000000), LB := ((17702276091275837 : Rat) / 100000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((182421003 : Rat) / 80000000), R := ((94912801 : Rat) / 40000000), D0 := ((94912801 : Rat) / 40000000), D1 := ((22213797 : Rat) / 40000000), D2 := ((22213797 : Rat) / 80000000), D3 := ((4406933392857142837 : Rat) / 10000000000000000000), D4 := ((12908712098214283201 : Rat) / 25000000000000000000), LB := ((15433660749123501 : Rat) / 1000000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((94912801 : Rat) / 40000000), R := ((766707007 : Rat) / 320000000), D0 := ((766707007 : Rat) / 320000000), D1 := ((7404599 : Rat) / 12800000), D2 := ((7404599 : Rat) / 40000000), D3 := ((3481358517857142837 : Rat) / 10000000000000000000), D4 := ((10594774910714283201 : Rat) / 25000000000000000000), LB := ((4569023915988979 : Rat) / 100000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((766707007 : Rat) / 320000000), R := ((387055803 : Rat) / 160000000), D0 := ((387055803 : Rat) / 160000000), D1 := ((96259787 : Rat) / 160000000), D2 := ((51832193 : Rat) / 320000000), D3 := ((3249964799107142837 : Rat) / 10000000000000000000), D4 := ((10016290613839283201 : Rat) / 25000000000000000000), LB := ((10223061013019369 : Rat) / 500000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((387055803 : Rat) / 160000000), R := ((1555627811 : Rat) / 640000000), D0 := ((1555627811 : Rat) / 640000000), D1 := ((392443747 : Rat) / 640000000), D2 := ((22213797 : Rat) / 160000000), D3 := ((3018571080357142837 : Rat) / 10000000000000000000), D4 := ((9437806316964283201 : Rat) / 25000000000000000000), LB := ((11440284680448193 : Rat) / 500000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1555627811 : Rat) / 640000000), R := ((156303241 : Rat) / 64000000), D0 := ((156303241 : Rat) / 64000000), D1 := ((199924173 : Rat) / 320000000), D2 := ((81450589 : Rat) / 640000000), D3 := ((2902874220982142837 : Rat) / 10000000000000000000), D4 := ((9148564168526783201 : Rat) / 25000000000000000000), LB := ((1670448414697677 : Rat) / 125000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((156303241 : Rat) / 64000000), R := ((1570437009 : Rat) / 640000000), D0 := ((1570437009 : Rat) / 640000000), D1 := ((81450589 : Rat) / 128000000), D2 := ((7404599 : Rat) / 64000000), D3 := ((2787177361607142837 : Rat) / 10000000000000000000), D4 := ((8859322020089283201 : Rat) / 25000000000000000000), LB := ((2495764051998889 : Rat) / 500000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1570437009 : Rat) / 640000000), R := ((3148278617 : Rat) / 1280000000), D0 := ((3148278617 : Rat) / 1280000000), D1 := ((821910489 : Rat) / 1280000000), D2 := ((66641391 : Rat) / 640000000), D3 := ((2671480502232142837 : Rat) / 10000000000000000000), D4 := ((8570079871651783201 : Rat) / 25000000000000000000), LB := ((9369050898763553 : Rat) / 1000000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3148278617 : Rat) / 1280000000), R := ((197230201 : Rat) / 80000000), D0 := ((197230201 : Rat) / 80000000), D1 := ((51832193 : Rat) / 80000000), D2 := ((125878183 : Rat) / 1280000000), D3 := ((2613632072544642837 : Rat) / 10000000000000000000), D4 := ((8425458797433033201 : Rat) / 25000000000000000000), LB := ((485773277947763 : Rat) / 78125000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((197230201 : Rat) / 80000000), R := ((632617563 : Rat) / 256000000), D0 := ((632617563 : Rat) / 256000000), D1 := ((836719687 : Rat) / 1280000000), D2 := ((7404599 : Rat) / 80000000), D3 := ((2555783642857142837 : Rat) / 10000000000000000000), D4 := ((8280837723214283201 : Rat) / 25000000000000000000), LB := ((4284780680353581 : Rat) / 1250000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((632617563 : Rat) / 256000000), R := ((1585246207 : Rat) / 640000000), D0 := ((1585246207 : Rat) / 640000000), D1 := ((422062143 : Rat) / 640000000), D2 := ((22213797 : Rat) / 256000000), D3 := ((2497935213169642837 : Rat) / 10000000000000000000), D4 := ((8136216648995533201 : Rat) / 25000000000000000000), LB := ((10214246603322263 : Rat) / 10000000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1585246207 : Rat) / 640000000), R := ((6348389427 : Rat) / 2560000000), D0 := ((6348389427 : Rat) / 2560000000), D1 := ((1695653171 : Rat) / 2560000000), D2 := ((51832193 : Rat) / 640000000), D3 := ((2440086783482142837 : Rat) / 10000000000000000000), D4 := ((7991595574776783201 : Rat) / 25000000000000000000), LB := ((181326541858469 : Rat) / 39062500000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6348389427 : Rat) / 2560000000), R := ((3177897013 : Rat) / 1280000000), D0 := ((3177897013 : Rat) / 1280000000), D1 := ((170305777 : Rat) / 256000000), D2 := ((199924173 : Rat) / 2560000000), D3 := ((2411162568638392837 : Rat) / 10000000000000000000), D4 := ((7919285037667408201 : Rat) / 25000000000000000000), LB := ((47337480695369 : Rat) / 12500000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3177897013 : Rat) / 1280000000), R := ((50905589 : Rat) / 20480000), D0 := ((50905589 : Rat) / 20480000), D1 := ((1710462369 : Rat) / 2560000000), D2 := ((96259787 : Rat) / 1280000000), D3 := ((2382238353794642837 : Rat) / 10000000000000000000), D4 := ((7846974500558033201 : Rat) / 25000000000000000000), LB := ((30473346778509547 : Rat) / 10000000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((50905589 : Rat) / 20480000), R := ((796325403 : Rat) / 320000000), D0 := ((796325403 : Rat) / 320000000), D1 := ((214733371 : Rat) / 320000000), D2 := ((7404599 : Rat) / 102400000), D3 := ((2353314138950892837 : Rat) / 10000000000000000000), D4 := ((7774663963448658201 : Rat) / 25000000000000000000), LB := ((485612399500801 : Rat) / 200000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((796325403 : Rat) / 320000000), R := ((6378007823 : Rat) / 2560000000), D0 := ((6378007823 : Rat) / 2560000000), D1 := ((1725271567 : Rat) / 2560000000), D2 := ((22213797 : Rat) / 320000000), D3 := ((2324389924107142837 : Rat) / 10000000000000000000), D4 := ((7702353426339283201 : Rat) / 25000000000000000000), LB := ((19348378628731289 : Rat) / 10000000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6378007823 : Rat) / 2560000000), R := ((3192706211 : Rat) / 1280000000), D0 := ((3192706211 : Rat) / 1280000000), D1 := ((866338083 : Rat) / 1280000000), D2 := ((170305777 : Rat) / 2560000000), D3 := ((2295465709263392837 : Rat) / 10000000000000000000), D4 := ((7630042889229908201 : Rat) / 25000000000000000000), LB := ((3934936358103991 : Rat) / 2500000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3192706211 : Rat) / 1280000000), R := ((6392817021 : Rat) / 2560000000), D0 := ((6392817021 : Rat) / 2560000000), D1 := ((348016153 : Rat) / 512000000), D2 := ((81450589 : Rat) / 1280000000), D3 := ((2266541494419642837 : Rat) / 10000000000000000000), D4 := ((7557732352120533201 : Rat) / 25000000000000000000), LB := ((13525503729608923 : Rat) / 10000000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6392817021 : Rat) / 2560000000), R := ((320011081 : Rat) / 128000000), D0 := ((320011081 : Rat) / 128000000), D1 := ((436871341 : Rat) / 640000000), D2 := ((155496579 : Rat) / 2560000000), D3 := ((2237617279575892837 : Rat) / 10000000000000000000), D4 := ((7485421815011158201 : Rat) / 25000000000000000000), LB := ((6392732875427909 : Rat) / 5000000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((320011081 : Rat) / 128000000), R := ((6407626219 : Rat) / 2560000000), D0 := ((6407626219 : Rat) / 2560000000), D1 := ((1754889963 : Rat) / 2560000000), D2 := ((7404599 : Rat) / 128000000), D3 := ((2208693064732142837 : Rat) / 10000000000000000000), D4 := ((7413111277901783201 : Rat) / 25000000000000000000), LB := ((13610171335046717 : Rat) / 10000000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6407626219 : Rat) / 2560000000), R := ((3207515409 : Rat) / 1280000000), D0 := ((3207515409 : Rat) / 1280000000), D1 := ((881147281 : Rat) / 1280000000), D2 := ((140687381 : Rat) / 2560000000), D3 := ((2179768849888392837 : Rat) / 10000000000000000000), D4 := ((7340800740792408201 : Rat) / 25000000000000000000), LB := ((805150932540577 : Rat) / 500000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3207515409 : Rat) / 1280000000), R := ((6422435417 : Rat) / 2560000000), D0 := ((6422435417 : Rat) / 2560000000), D1 := ((1769699161 : Rat) / 2560000000), D2 := ((66641391 : Rat) / 1280000000), D3 := ((2150844635044642837 : Rat) / 10000000000000000000), D4 := ((7268490203683033201 : Rat) / 25000000000000000000), LB := ((4076593375643367 : Rat) / 2000000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((6422435417 : Rat) / 2560000000), R := ((401865001 : Rat) / 160000000), D0 := ((401865001 : Rat) / 160000000), D1 := ((22213797 : Rat) / 32000000), D2 := ((125878183 : Rat) / 2560000000), D3 := ((2121920420200892837 : Rat) / 10000000000000000000), D4 := ((7196179666573658201 : Rat) / 25000000000000000000), LB := ((3323500857746603 : Rat) / 1250000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((401865001 : Rat) / 160000000), R := ((1287448923 : Rat) / 512000000), D0 := ((1287448923 : Rat) / 512000000), D1 := ((1784508359 : Rat) / 2560000000), D2 := ((7404599 : Rat) / 160000000), D3 := ((2092996205357142837 : Rat) / 10000000000000000000), D4 := ((7123869129464283201 : Rat) / 25000000000000000000), LB := ((8719919758234801 : Rat) / 2500000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1287448923 : Rat) / 512000000), R := ((3222324607 : Rat) / 1280000000), D0 := ((3222324607 : Rat) / 1280000000), D1 := ((895956479 : Rat) / 1280000000), D2 := ((22213797 : Rat) / 512000000), D3 := ((2064071990513392837 : Rat) / 10000000000000000000), D4 := ((7051558592354908201 : Rat) / 25000000000000000000), LB := ((56811305335943 : Rat) / 12500000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((3222324607 : Rat) / 1280000000), R := ((1614864603 : Rat) / 640000000), D0 := ((1614864603 : Rat) / 640000000), D1 := ((451680539 : Rat) / 640000000), D2 := ((51832193 : Rat) / 1280000000), D3 := ((2035147775669642837 : Rat) / 10000000000000000000), D4 := ((6979248055245533201 : Rat) / 25000000000000000000), LB := ((5105894107637621 : Rat) / 10000000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1614864603 : Rat) / 640000000), R := ((647426761 : Rat) / 256000000), D0 := ((647426761 : Rat) / 256000000), D1 := ((910765677 : Rat) / 1280000000), D2 := ((22213797 : Rat) / 640000000), D3 := ((1977299345982142837 : Rat) / 10000000000000000000), D4 := ((6834626981026783201 : Rat) / 25000000000000000000), LB := ((2015832641156401 : Rat) / 500000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((647426761 : Rat) / 256000000), R := ((811134601 : Rat) / 320000000), D0 := ((811134601 : Rat) / 320000000), D1 := ((229542569 : Rat) / 320000000), D2 := ((7404599 : Rat) / 256000000), D3 := ((1919450916294642837 : Rat) / 10000000000000000000), D4 := ((6690005906808033201 : Rat) / 25000000000000000000), LB := ((8984704370537 : Rat) / 1000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((811134601 : Rat) / 320000000), R := ((1629673801 : Rat) / 640000000), D0 := ((1629673801 : Rat) / 640000000), D1 := ((466489737 : Rat) / 640000000), D2 := ((7404599 : Rat) / 320000000), D3 := ((1861602486607142837 : Rat) / 10000000000000000000), D4 := ((6545384832589283201 : Rat) / 25000000000000000000), LB := ((2736576192727991 : Rat) / 500000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((1629673801 : Rat) / 640000000), R := ((511587 : Rat) / 200000), D0 := ((511587 : Rat) / 200000), D1 := ((7404599 : Rat) / 10000000), D2 := ((7404599 : Rat) / 640000000), D3 := ((1745905627232142837 : Rat) / 10000000000000000000), D4 := ((6256142684151783201 : Rat) / 25000000000000000000), LB := ((30269114757195403 : Rat) / 1000000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((511587 : Rat) / 200000), R := ((410899808767857142837 : Rat) / 160000000000000000000), D0 := ((410899808767857142837 : Rat) / 160000000000000000000), D1 := ((120103792767857142837 : Rat) / 160000000000000000000), D2 := ((1630208767857142837 : Rat) / 160000000000000000000), D3 := ((1630208767857142837 : Rat) / 10000000000000000000), D4 := ((5966900535714283201 : Rat) / 25000000000000000000), LB := ((7288172423723771 : Rat) / 200000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((410899808767857142837 : Rat) / 160000000000000000000), R := ((206265008767857142837 : Rat) / 80000000000000000000), D0 := ((206265008767857142837 : Rat) / 80000000000000000000), D1 := ((60867000767857142837 : Rat) / 80000000000000000000), D2 := ((1630208767857142837 : Rat) / 80000000000000000000), D3 := ((4890626303571428511 : Rat) / 32000000000000000000), D4 := ((182789773303571348247 : Rat) / 800000000000000000000), LB := ((4535500180517349 : Rat) / 500000000000000000) },
  ...
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((107208026303571428511 : Rat) / 40000000000000000000), R := ((27209558767857142837 : Rat) / 10000000000000000000), D0 := ((27209558767857142837 : Rat) / 10000000000000000000), D1 := ((9034807767857142837 : Rat) / 10000000000000000000), D2 := ((1630208767857142837 : Rat) / 10000000000000000000), D3 := ((1630208767857142837 : Rat) / 40000000000000000000), D4 := ((23282072767857123053 : Rat) / 200000000000000000000), LB := ((6427761055469083 : Rat) / 100000000000000000) },
  { w1 := ((10214579730994233 : Rat) / 10000000000000000), w2 := ((995026954894167 : Rat) / 25000000000000000), w3 := ((5558378298072043 : Rat) / 20000000000000000), w4 := (0 : Rat), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((27209558767857142837 : Rat) / 10000000000000000000), s4 := ((69915275535714283201 : Rat) / 25000000000000000000), L := ((27209558767857142837 : Rat) / 10000000000000000000), R := ((34504895089285714317 : Rat) / 12500000000000000000), D0 := ((34504895089285714317 : Rat) / 12500000000000000000), D1 := ((11786456339285714317 : Rat) / 12500000000000000000), D2 := ((2530707589285714317 : Rat) / 12500000000000000000), D3 := ((1971786517857143083 : Rat) / 50000000000000000000), D4 := ((3782757232142852217 : Rat) / 50000000000000000000), LB := ((6772617098461331 : Rat) / 1000000000000000000) }
]

def block292RightChunk000L : Rat := ((88009805803571428697 : Rat) / 50000000000000000000)
def block292RightChunk000R : Rat := ((34504895089285714317 : Rat) / 12500000000000000000)

def block292RightChunk000Certificate : Bool :=
  allBoxesValid block292RightChunk000 &&
  coversFromBool block292RightChunk000 block292RightChunk000L block292RightChunk000R

theorem block292RightChunk000Certificate_eq_true :
    block292RightChunk000Certificate = true := by
  native_decide

def block292RightChainCertificate : Bool :=
  decide (
    block292RightL = ((88009805803571428697 : Rat) / 50000000000000000000) /\
    ((34504895089285714317 : Rat) / 12500000000000000000) = block292RightR)

theorem block292RightChainCertificate_eq_true :
    block292RightChainCertificate = true := by
  native_decide

def block292LeftBoxCount : Nat := boxCount block292LeftBoxes
def block292RightBoxCount : Nat := 57

def block292_rational_certificate : Prop :=
    block292LeftCertificate = true /\
    block292RightChainCertificate = true /\
    block292RightChunk000Certificate = true

theorem block292_rational_certificate_proof :
    block292_rational_certificate := by
  exact ⟨block292LeftCertificate_eq_true, block292RightChainCertificate_eq_true, block292RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block292.block292V
#check Erdos1038Lean.M1817475.Block292.block292_left_V_pos
#check Erdos1038Lean.M1817475.Block292.block292_right_V_pos
#check Erdos1038Lean.M1817475.Block292.block292_reallog_certificate_proof
