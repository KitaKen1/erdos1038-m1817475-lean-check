...
Block 154 real-log V_i(y) > 0 check for the M=1.817475 candidate.
...
def block154RightChunk000 : List RatBox := [
  ...
  { w1 := ((4291467441125973 : Rat) / 2000000000000000), w2 := (0 : Rat), w3 := ((17168721654531977 : Rat) / 100000000000000000), w4 := ((8171873467124889 : Rat) / 100000000000000000), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((136751561696428571297 : Rat) / 50000000000000000000), s4 := ((27844905749999999 : Rat) / 10000000000000000), L := ((2225119492946428496297 : Rat) / 800000000000000000000), R := ((27844905749999999 : Rat) / 10000000000000000), D0 := ((27844905749999999 : Rat) / 10000000000000000), D1 := ((9670154749999999 : Rat) / 10000000000000000), D2 := ((2265555749999999 : Rat) / 10000000000000000), D3 := ((2472967053571423703 : Rat) / 50000000000000000000), D4 := ((2472967053571423703 : Rat) / 800000000000000000000), LB := ((49178280882813 : Rat) / 1562500000000000) },
  { w1 := ((4291467441125973 : Rat) / 2000000000000000), w2 := (0 : Rat), w3 := ((17168721654531977 : Rat) / 100000000000000000), w4 := ((8171873467124889 : Rat) / 100000000000000000), s1 := ((18174751 : Rat) / 10000000), s2 := ((511587 : Rat) / 200000), s3 := ((136751561696428571297 : Rat) / 50000000000000000000), s4 := ((27844905749999999 : Rat) / 10000000000000000), L := ((27844905749999999 : Rat) / 10000000000000000), R := ((69684234375000000033 : Rat) / 25000000000000000000), D0 := ((69684234375000000033 : Rat) / 25000000000000000000), D1 := ((24247356875000000033 : Rat) / 25000000000000000000), D2 := ((5735859375000000033 : Rat) / 25000000000000000000), D3 := ((2616907053571428769 : Rat) / 50000000000000000000), D4 := ((71970000000002533 : Rat) / 25000000000000000000), LB := ((19195061520925927 : Rat) / 1000000000000000000) }
]

def block154RightChunk000L : Rat := ((17871738839285714299 : Rat) / 10000000000000000000)
def block154RightChunk000R : Rat := ((69684234375000000033 : Rat) / 25000000000000000000)

def block154RightChunk000Certificate : Bool :=
  allBoxesValid block154RightChunk000 &&
  coversFromBool block154RightChunk000 block154RightChunk000L block154RightChunk000R

theorem block154RightChunk000Certificate_eq_true :
    block154RightChunk000Certificate = true := by
  native_decide

def block154RightChainCertificate : Bool :=
  decide (
    block154RightL = ((17871738839285714299 : Rat) / 10000000000000000000) /\
    ((69684234375000000033 : Rat) / 25000000000000000000) = block154RightR)

theorem block154RightChainCertificate_eq_true :
    block154RightChainCertificate = true := by
  native_decide

def block154LeftBoxCount : Nat := boxCount block154LeftBoxes
def block154RightBoxCount : Nat := 70

def block154_rational_certificate : Prop :=
    block154LeftCertificate = true /\
    block154RightChainCertificate = true /\
    block154RightChunk000Certificate = true

theorem block154_rational_certificate_proof :
    block154_rational_certificate := by
  exact ⟨block154LeftCertificate_eq_true, block154RightChainCertificate_eq_true, block154RightChunk000Certificate_eq_true⟩
...
#check Erdos1038Lean.M1817475.Block154.block154V
#check Erdos1038Lean.M1817475.Block154.block154_left_V_pos
#check Erdos1038Lean.M1817475.Block154.block154_right_V_pos
#check Erdos1038Lean.M1817475.Block154.block154_reallog_certificate_proof
